...
void func_8015EE28(void) {
    ...
    for (i = 1; i < 4; i++) {
        ...
        if ((temp_s0 == 1) || (var_a0 & 0x8000)) {
            ...
            if ((collider.effects & 0x803) == 0x801) {
                if (i < 2) {
                    *vram_ptr |= (0x802 | ((collidereffects >> 4) & 0x700));
                    if (!(*vram_ptr & 1)) {
                        newY = *yPosPtr + 1 +
