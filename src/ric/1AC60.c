...
void func_801587D0(void) {
    D_80175956 = 1;
    D_80175950 = D_800733D8->animationFrame;
    D_80175952 = D_800733D8->unk19;
...
void func_80158814(void) {
    D_80175956 = 0;
    D_800733D8->unk44 = 0;
    D_800733D8->animationFrame = D_80175950;
    D_800733D8->unk19 = *(u8*)&D_80175952;
...
void func_80159BC8(void) {
    ...
    D_80072F64[0] = 0;
    D_80072F66 = 0;
    D_800733D8->unk19 = D_800733D8->unk19 & 0xFB;
}
...
void func_8015CCC8(s32 arg0, s32 arg1) {
    ...
    if (arg0 == 1) {
        D_800733D8->unk4C = &D_801554B0;
        D_800733D8->unk2E = 4;
    }
    if (arg0 == 2) {
        D_800733D8->unk4C = &D_801554D0;
        D_800733D8->unk2E = 1;
    }
    if (arg0 == 3) {
        D_800733D8->unk4C = &D_801554C8;
        D_800733D8->unk2E = 4;
    }
}
