...
#ifndef NON_MATCHING // This function matches with GCC 2.7.2 using -01 Compilation flags
INCLUDE_ASM("asm/ric/nonmatchings/1AC60", func_8015FA5C); // https://decomp.me/scratch/VaPMV
#else
