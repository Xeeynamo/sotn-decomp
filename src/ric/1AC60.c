...
void func_801587D0(void) {
    D_80175956 = 1;
    D_80175950 = g_EntityArray->animationFrame;
    D_80175952 = g_EntityArray->unk19;
    D_80175954 = g_EntityArray->palette;
}

void func_80158814(void) {
    D_80175956 = 0;
    g_EntityArray->unk44 = 0;
    g_EntityArray->animationFrame = D_80175950;
    g_EntityArray->unk19 = *(u8*)&D_80175952;
    g_EntityArray->palette = D_80175954;
}
...
void func_80159BC8(void) {
    ...
    D_80072F64[0] = 0;
    D_80072F66 = 0;
    g_EntityArray->unk19 = g_EntityArray->unk19 & 0xFB;
}
...
void func_8015CAAC(s32 speed) {
    ...
    if (g_EntityArray->objectRoomIndex == 1)
        phi_a0 = -speed;
    g_EntityArray->accelerationX = phi_a0;
}
...
void func_8015CC70(s16 arg0) {
    ...
    g_EntityArray->initState = 0x0020;
    g_EntityArray->animationFrameDuration = 0;
    g_EntityArray->animationFrameIndex = 0;
    if (arg0 & 1) {
        g_EntityArray->unk4C = &D_80155950;
    } else {
        g_EntityArray->unk4C = &D_8015591C;
    }
}
...
void func_8015CCC8(s32 arg0, s32 arg1) {
    ...
    if (arg0 == 1) {
        g_EntityArray->unk4C = &D_801554B0;
        g_EntityArray->unk2E = 4;
    }
    if (arg0 == 2) {
        g_EntityArray->unk4C = &D_801554D0;
        g_EntityArray->unk2E = 1;
    }
    if (arg0 == 3) {
        g_EntityArray->unk4C = &D_801554C8;
        g_EntityArray->unk2E = 4;
    }
}
...
void func_80166024() {
    g_EntityArray->palette = 0x815E;
    D_800733F0 = 0x70;
}

void func_80166044() {
    g_EntityArray->palette = 0x8120;
    D_800733F0 = 0;
}
