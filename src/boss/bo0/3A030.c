...
static void PlayOlroxDroolSfx(s16 sfxId) {
    s32 yOffset;
    s16 vol;
    s16 pan;
    s32 xOffset;
...
// same as psp/func_pspeu_09258B10
INCLUDE_ASM("boss/bo0/nonmatchings/3A030", func_us_801BA4AC);

// dead code
INCLUDE_ASM("boss/bo0/nonmatchings/3A030", func_us_801BA724);
