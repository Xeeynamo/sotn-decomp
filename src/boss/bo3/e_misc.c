...
INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", EntityExplosionVariantsSpawner);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", EntityGreyPuffSpawner);
...
INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", UnkCollisionFunc5);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", UnkCollisionFunc4);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", EntityIntenseExplosion);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", InitializeUnkEntity);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", MakeEntityFromId);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", MakeExplosions);
...
INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", ClutLerp);

INCLUDE_ASM("boss/bo3/nonmatchings/e_misc", PlaySfxPositional);
