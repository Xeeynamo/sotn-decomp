...
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", EntityExplosionVariants);
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", EntityGreyPuff);
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", EntityOlroxDrool);
...
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", InitializeUnkEntity);
...
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", EntityBigRedFireball);
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", UnkRecursivePrimFunc1);
INCLUDE_ASM("boss/bo7/nonmatchings/e_misc", UnkRecursivePrimFunc2);
