...
extern s16 D_8013901C; // very likely: "has CD music track actually started playing?"
extern u8 g_MuteCd;
...
extern u_long D_80139A7C[32 * 40]; // size from D_800AE130, D_800AE138
...
volatile extern u8 g_SoundInitialized;
