...
void func_80111CC0(void) {
    if (g_Player.D_80072F02 != 0) {
        CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0, 0x1700, 44), 0);
    }
    if (g_Player.D_80072F00 != 0) {
        CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0, 0x1600, 44), 0);
    }
}
...
bool func_80111DE8(bool mistReset) {
    ...
    yOffset = D_800ACED0.pairs[1].unk2 - 1;
...
void func_801120B4(void) {
    ...
    if ((PLAYER.step < 0x40U) && (g_Player.unk48 == 0)) {
        if (D_800ACF74 != 0) {
            ...
            CreateEntFactoryFromEntity(g_CurrentEntity, 0xD0004U, 0);
            D_800ACF74 = 0x60;
            PLAYER.posY.i.hi += 0x10;
    ...
    case 0x4:
        if (PLAYER.ext.player.unkAC == 0xF2 && --D_800ACF78 == 0) {
            ...
            CreateEntFactoryFromEntity(g_CurrentEntity, 0x7AU, 0);
            D_800ACF78 = 0x200;
        }
        local_flags = 1;
        break;
