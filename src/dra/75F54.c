...
bool func_8012C88C(void) {
    if ((PLAYER.pl_step_s != 0) && (PLAYER.pl_step_s != 8)) {
...
void func_8012CED4(void) {
    if ((PLAYER.pl_step_s == 2) && (D_800B0914 == PLAYER.pl_step_s)) {
        func_8010DA48(0xE7);
        D_800B0914 = 1;
    } else {
        func_8010DA48(0xE8);
