    ...
    case 1:
        ...
        if (func_8010FDF8(0x20280) != 0) {
            ...
            if (randvar << 0x10) {
                ...
                func_8010DA48(0x3A);
                CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0x700,29), 0);
            }
            PLAYER.step_s = 2;
        }
        break;
        ...
        if (g_Player.padTapped & (PAD_UP | PAD_RIGHT | PAD_DOWN | PAD_LEFT) ||
            ...
            if (g_Player.unk5E == 0) {
                ...
                if (PLAYER.ext.player.unkAC != 0x3A) {
                    ...
                    CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0,32), 0);
                }
                PlaySfx(0x6E7);
            ...
            PLAYER.step_s = 3;
            if (PLAYER.ext.player.unkAC != 0x3A) {
                CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0x300,13), 0);
                CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0x300,31), 0);
            } else {
                CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0x800,13), 0);
                CreateEntFactoryFromEntity(g_CurrentEntity, FACTORY(0x700,30), 0);
            }
        }
