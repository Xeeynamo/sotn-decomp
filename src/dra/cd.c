...
CdFileSeq D_800ACCF8[] = {
    {0x7D6A, SEQ_LIB_SEQ_LEN, MU_SEQ_LIBRARIAN},
    {0x7C0C, SEQ_DAI_SEQ_LEN, MU_SEQ_CONFESSIONAL_BELLS},
};
#elif defined(VERSION_HD)
CdFileSeq D_800ACCF8[] = {
    {0x7DA4, SEQ_LIB_SEQ_LEN, MU_SEQ_LIBRARIAN},
    {0x7C48, SEQ_DAI_SEQ_LEN, MU_SEQ_CONFESSIONAL_BELLS},
};
#endif
