...
u8 g_Stage15ExplosionAnimUnused[] = {1, 0x43, 0, 0};

u8* g_Stage15ExplosionAnimations[5] = {
    g_Stage15ExplosionAnimSmall,         g_Stage15ExplosionAnimFireball,
    g_Stage15ExplosionAnimSmallMultiple, g_Stage15ExplosionAnimBig,
    g_Stage15ExplosionAnimUnused,
};

u16 g_Stage15ExplosionInit[5] = {1, 2, 4, 5, 1};
u16 g_Stage15ExplosionInitPadding = 0;
