...
u8 g_Stage15SkeletonBeastAnimationData[] = {
    /* Idle */
    6, 1, 4, 1, 4, 2, 6, 3, 5, 4, 5, 5, 0xFF, 0xFF,
    /* Walk */
    6, 1, 4, 2, 4, 3, 6, 4, 5, 5, 5, 6, 0xFF, 0xFF,
    /* Walk back */
    6, 1, 5, 6, 5, 5, 6, 4, 4, 3, 4, 2, 0xFF, 0xFF,
    /* Attack */
    5, 7, 6, 8, 5, 9, 5, 0xA, 5, 0xB, 5, 0xC, 0xFF, 0xFF,
    /* Jump */
    1, 1, 4, 0xD, 4, 0xE, 1, 1, 0xFF, 0xFF,
    /* Land */
    1, 1, 4, 0xD, 6, 0xE, 4, 0xD, 1, 1, 0xFF, 0xFF,
};
