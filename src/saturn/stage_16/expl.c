...
u8 g_Stage16ExplosionAnimUnused[] = {1, 0x43, 0, 0};

u8* g_Stage16ExplosionAnimations[5] = {
    g_Stage16ExplosionAnimSmall,         g_Stage16ExplosionAnimFireball,
    g_Stage16ExplosionAnimSmallMultiple, g_Stage16ExplosionAnimBig,
    g_Stage16ExplosionAnimUnused,
};

u16 g_Stage16ExplosionInit[5] = {1, 2, 4, 5, 1};
u16 g_Stage16ExplosionInitPadding = 0;
