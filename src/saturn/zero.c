...
void func_06005508(void) {
    ...
    ReadFileToAddr("ASCII.FON", (s32)&DAT_00252000);
    func_060100DC();
...
void func_0600583C(void) {
    ...
    DAT_0605D7DC += ReadFileToAddr((char*)&DAT_0600582C, DAT_0605D7DC);
    if (DAT_0605D7DC & 1) {
        DAT_0605D7DC++;
    }
}
...
const u16 DAT_0600597C[] = {
    0x5334, 0x3330, 0x2E50, 0x544E, 0x0000, 0x0009, 0x5334, 0x3330,
    0x2E43, 0x4852, 0x0000, 0x0009, 0x5334, 0x3430, 0x2E50, 0x544E,
    0x0000, 0x0009, 0x5334, 0x3430, 0x2E43, 0x4852, 0x0000, 0x0009,
    0x5334, 0x3130, 0x2E50, 0x544E, 0x0000, 0x0009, 0x5334, 0x3130,
    0x2E43, 0x4852, 0x0000, 0x0009, 0x5334, 0x3030, 0x2E50, 0x544E,
    0x0000, 0x0009, 0x5334, 0x3030, 0x2E43, 0x4852, 0x0000, 0x0009,
};
...
void func_06008488(void) {
    ...
    palettes = (s32*)((SPR_2LookupTblNoToVram(0x10) * 8) + 0x25C00000);
    entry = d_0605DB60;
    for (i = 0; i < 0x20;) {
        if (entry->unk0 != NULL) {
...
void func_0600C628(s32* source, s32 rowCount) {
    s32 row;
    s32* destination;

    rowCount = (rowCount + 0xB) / 12;
    destination = func_0600CB04(0x140, 0x87);
    row = 0;
    while (row < rowCount) {
        DMA_CpuMemCopy2(destination, source, 0xC0U);
        while (DMA_CpuResult() == 2) {
        }
        row++;
        destination += 0x100;
