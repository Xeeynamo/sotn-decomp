...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601B4AC, func_0601B4AC); // GFS_NameToId
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601B518, func_0601B518); // _GFS_IdToName
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601B58C, func_0601B58C); // _GFS_GetDirInfo
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601B8B4, func_0601B8B4); // _GFS_ByteToSct
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601BD20, func_0601BD20); // _GFS_NwCdRead
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601BD94, func_0601BD94); // _GFS_NwIsComplete
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601BEB8, func_0601BEB8); // _gfs_recovRdErr
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601BEE8, func_0601BEE8);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601BFA8, func_0601BFA8); // _GFS_NwExecServer
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C1BC, func_0601C1BC); // _GFS_SetTrFunc
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C220, func_0601C220); // _GFS_StartTrans
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C26C, func_0601C26C); // _GFS_CdMovePickup
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C2D8, func_0601C2D8); // _GFS_SetErrFunc
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C308, func_0601C308);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C32C, func_0601C32C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C354, func_0601C354); // _gfs_chgRoot
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C420, func_0601C420);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C42C, func_0601C42C); // _gfs_mngSetupFuncTbl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C4A8, func_0601C4A8); // _gfs_mngInitWork
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C54C, func_0601C54C); // _gfs_mngGetNumFile
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C5B0, func_0601C5B0); // _GFS_mngAllocGrp
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C5F8, func_0601C5F8);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C604, func_0601C604); // _gfs_mngTermAccess
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C680, func_0601C680); // _gfs_mngSetErrCode
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C6C8, func_0601C6C8); // _gfs_svrSearchHndl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C708, func_0601C708); // _gfs_svrAddHndl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C744, func_0601C744); // _gfs_svrRemoveHndl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C7A0, func_0601C7A0); // _GFS_OpenSub
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C840, func_0601C840); // _gfs_loadVol
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C908, func_0601C908); // _gfs_getRootDir
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601C9FC, func_0601C9FC); // _gfs_loadRootDir
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CCA0, func_0601CCA0); // _gfs_closeSub
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CCF0, func_0601CCF0);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CD08, func_0601CD08);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CD50, func_0601CD50); // _gfs_convFinStat
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CFA0, func_0601CFA0); // _GFCF_SetSct
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601CFEC, func_0601CFEC); // _GFCF_GetFileInfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D060, func_0601D060);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D1B0, func_0601D1B0); // _GFCF_StopInBuf
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D250, func_0601D250); // _GFCF_Recover
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D29C, func_0601D29C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D2B4, func_0601D2B4);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D2CC, func_0601D2CC); // _GFCF_MovePickup
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D36C, func_0601D36C); // _GFCF_cnvIntlvOfs
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D3BC, func_0601D3BC); // _GFCF_GetStat
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D440, func_0601D440); // _gfcf_getSctSize
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D478, func_0601D478); // _gfcf_isCdOk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D534, func_0601D534); // _gfcf_getPlayRange
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D758, func_0601D758); // _GFSF_FlowInBuf
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601D94C, func_0601D94C); // _GFSF_FlowInBuf
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601DB34, func_0601DB34); // _GFDR_ChgDir
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E16C, func_0601E16C); // _gfdr_readByte
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E198, func_0601E198);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E1C4, func_0601E1C4); // _gfdr_readWordNB
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E218, func_0601E218); // _gfdr_readLongNB
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E264, func_0601E264);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E28C, func_0601E28C); // _gfdr_setNextRec
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E318, func_0601E318);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E688, func_0601E688); // _gfdr_setDirrecCd
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E6C4, func_0601E6C4); // _gfdr_setDirrecMem
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E700, func_0601E700); // _gfdr_setDirrecScsi
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E728, func_0601E728); // _gfdr_getScsiFinfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E7B8, func_0601E7B8); // _gfdr_findScsiFile
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E7E4, func_0601E7E4); // _gfdr_findFile
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E834, func_0601E834); // _gfdr_clearMemRsv
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601E904, func_0601E904); // _GFTR_SetTransPara
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601EB2C, func_0601EB2C); // _GFTR_ExecSvr
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601EC30, func_0601EC30); // _gftr_getSrcPack
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601ECB8, func_0601ECB8); // _gftr_getDstPack
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601ED14, func_0601ED14);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601ED20, func_0601ED20); // _gftr_execScu
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601EDBC, func_0601EDBC); // _gftr_remScu
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601EEF4, func_0601EEF4); // _gfdma_getBytecnt
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601EFDC, func_0601EFDC); // _gftr_execCpu
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F01C, func_0601F01C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F028, func_0601F028); // _gftr_reqTrn
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F128, func_0601F128);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F160, func_0601F160); // _gftr_remTrn
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F1C8, func_0601F1C8); // _gftr_copyFrac
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F1F0, func_0601F1F0);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F1FC, func_0601F1FC);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F210, func_0601F210); // _GFTR_GetDstPack
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F2F4, func_0601F2F4); // _GFBF_GetNumData
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F840, func_0601F840); // _GFCB_GetSctData
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601F8E8, func_0601F8E8); // _GFCB_SetCon
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FB98, func_0601FB98); // _GFCD_AllocFilt
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FBD0, func_0601FBD0); // _GFCD_FreeFilt
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FC00, func_0601FC00); // _GFCD_AllocBuf
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FC34, func_0601FC34);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FCD4, func_0601FCD4); // _GFCD_GetBaseFad
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FD08, func_0601FD08); // _GFCD_GetPickup
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FD3C, func_0601FD3C); // _GFCD_UngetPickup
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FD68, func_0601FD68);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FD8C, func_0601FD8C); // _GFCD_SetFilt
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FE4C, func_0601FE4C); // _GFCD_GetFilt
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FE94, func_0601FE94); // _GFCD_SetCon
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FEEC, func_0601FEEC); // _GFCD_Play
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FF4C, func_0601FF4C); // _GFCD_GetLenData
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f601FFB0, func_0601FFB0); // _GFCD_ReqData
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602000C, func_0602000C); // _GFCD_EndData
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020054, func_06020054);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60200A8, func_060200A8);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60200D4, func_060200D4); // _GFCD_GetStat
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020188, func_06020188); // _GFCD_MovePickup
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60201D4, func_060201D4); // _GFCD_MoveSctData
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020240, func_06020240);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020264, func_06020264); // _GFCD_GetSctInfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60202AC, func_060202AC); // _GFCD_ChgDir
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020328, func_06020328); // _GFCD_SetFiltCon
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020420, func_06020420); // _GFCD_GetFileInfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60204F8, func_060204F8); // _GFCD_GetBufSiz
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020530, func_06020530); // _GFCD_ExecServer
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602060C, func_0602060C); // _gfcd_isIdleTask
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020698, func_06020698); // _gfcd_doTask
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020744, func_06020744);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020758, func_06020758); // _GFCD_WaitServer
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020794, func_06020794); // _gfcd_doSetFiltTsk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602093C, func_0602093C); // _gfcd_doSetConTsk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60209C8, func_060209C8); // _gfcd_doGetLenDataTsk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020B18, func_06020B18); // _gfcd_doReqDataTsk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020BB8, func_06020BB8); // _gfcd_doDelSctDataTsk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6020CE8, func_06020CE8); // _gfcd_doMoveSctTsk
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60211A4, func_060211A4); // _gfcd_initCdbMng
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60212AC, func_060212AC); // _GFCD_WaitScdqFlag
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60212F0, func_060212F0); // _GFCD_WaitPause
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021434, func_06021434); // _GFMB_GetSrcPack
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021510, func_06021510); // _GFMC_GetFileInfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021564, func_06021564); // _GFMC_GetNumFile
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021670, func_06021670); // _GFSB_GetLenData
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60216F4, func_060216F4); // _GFSB_GetSrcPack
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021770, func_06021770); // _GFSB_RtnPk
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60217C0, func_060217C0); // _gfsb_getActSiz
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60218E8, func_060218E8); // SPR_SetTvMode
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021A58, func_06021A58); // SPR_GetStatus
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6021AE8, func_06021AE8);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022060, func_06022060);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022088, func_06022088); // SPR_SetEosMode
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022514, func_06022514); // SPR_2SetTvMode
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022588, func_06022588); // SPR_2FrameChgIntr
// func_060225C4 is SPR_2FrameEraseData, splitter bug
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60225F4, func_060225F4); 
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602262C, func_0602262C); // SPR_2SetGourTbl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022678, func_06022678); // SPR_2SetLookupTbl
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60226D0, func_060226D0); // SPR_2ClrAllChar
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022768, func_06022768); // SPR_2GourTblNoToVram
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60227AC, func_060227AC); // SPR_2LookupTblNoToVram
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60227E4, func_060227E4); // SPR_2CharNoToVram
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602281C, func_0602281C); // SPR_2GetAreaSizeInfo
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f602292C, func_0602292C); // SPR_2OpenCommand
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022A48, func_06022A48);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022C7C, func_06022C7C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022C9C, func_06022C9C); // SPR_2LocalCoord
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022D28, func_06022D28); // SPR_2SysClip
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022D98, func_06022D98); // SPR_2UserClip
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022E2C, func_06022E2C); // SPR_2Cmd
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6022E8C, func_06022E8C); // SPR_2FlushDrawPrtyBlock
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60230B8, func_060230B8); // SlaveFlushDrawPrtyBlock
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6023108, func_06023108);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6023114, func_06023114); // SPR_RunSlaveSH
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6023144, func_06023144);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60231C0, func_060231C0); // flushDrawPrtyBlock
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6030518, func_06030518); // change_dfunc
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6030554, func_06030554); // return_dfunc
