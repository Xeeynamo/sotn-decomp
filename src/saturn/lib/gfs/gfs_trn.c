...
GFS_LOCAL void gftr_execScu(void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte);
GFS_LOCAL Sint32 gftr_remScu(void);
GFS_LOCAL Bool gfdma_canUse(Sint32 ch);
GFS_LOCAL void gfdma_exec(Sint32 ch, void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte);
GFS_LOCAL Sint32 gfdma_getBytecnt(Sint32 ch);
GFS_LOCAL Bool gftr_reqDma0(void);
GFS_LOCAL void gftr_execSdma0(void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte);
GFS_LOCAL Sint32 gftr_remDma0(void);
GFS_LOCAL Sint32 gftr_remDma1(void);
GFS_LOCAL void gftr_execSdma1(void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte);
GFS_LOCAL Bool gftr_reqDma1(void);
GFS_LOCAL Bool gftr_reqCpu(void);
GFS_LOCAL void gftr_execCpu(void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte);
...
GFS_LOCAL void gfdma_exec(Sint32 ch, void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte) {
    ...
    if (cnt > 0) {
        ...
        com_prm.msk = DMA_CPU_M_PR | DMA_CPU_M_AE | 
                        DMA_CPU_M_NMIF | DMA_CPU_M_DME;
...
// 0x0601EF94
void gftr_execSdma1(void *dst, Sint32 dmode, void *src, Sint32 smode, Sint32 nbyte) {
