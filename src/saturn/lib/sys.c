...
const interrupt_t g_SysUintMacSaveStubs[32] = {
    (interrupt_t)0x06030CA4,
    (interrupt_t)0x06030CAA,
    (interrupt_t)0x06030CB0,
    (interrupt_t)0x06030CB6,
    (interrupt_t)0x06030CBC,
    (interrupt_t)0x06030CC2,
    (interrupt_t)0x06030CC8,
    (interrupt_t)0x06030CCE,
    (interrupt_t)0x06030CD4,
    (interrupt_t)0x06030CDA,
    (interrupt_t)0x06030CE0,
    (interrupt_t)0x06030CE6,
    (interrupt_t)0x06030CEC,
    (interrupt_t)0x06030CF2,
    NULL,
    NULL,
    (interrupt_t)0x06030CF8,
    (interrupt_t)0x06030CFE,
    (interrupt_t)0x06030D04,
    (interrupt_t)0x06030D0A,
    (interrupt_t)0x06030D10,
    (interrupt_t)0x06030D16,
    (interrupt_t)0x06030D1C,
    (interrupt_t)0x06030D22,
    (interrupt_t)0x06030D28,
    (interrupt_t)0x06030D2E,
    (interrupt_t)0x06030D34,
    (interrupt_t)0x06030D3A,
    (interrupt_t)0x06030D40,
    (interrupt_t)0x06030D46,
    (interrupt_t)0x06030D4C,
    (interrupt_t)0x06030D52,
};
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6030E38, func_06030E38);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6030E6C, func_06030E6C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6030F0C, func_06030F0C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031048, func_06031048);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60310D4, func_060310D4);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60315A8, __adddf3);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031608, __subdf3);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f603168C, func_0603168C);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60319E8, __muldf3);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031A50, func_06031A50);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031BA4, __divdf3);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031EC0, __ltdf2);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031F20, func_06031F20);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6031F88, __floatsidf);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032014, __fixdfsi);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f603216C, __fixunsdfsi);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032E04, func_06032E04);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032EA8, func_06032EA8);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032EFC, func_06032EFC);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032F50, sprintf);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032FAC, memcmp);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6032FDC, func_06032FDC);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6033024, func_06033024);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60330C0, strncmp);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60330F8, strncpy);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6033308, func_06033308);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6035278, func_06035278);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6035C3C, func_06035C3C);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f60363A4, func_060363A4);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6038820, func_06038820);
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6038834, func_06038834);
...
INCLUDE_ASM("asm/saturn/zero/f_nonmat", f6038948, func_06038948);
