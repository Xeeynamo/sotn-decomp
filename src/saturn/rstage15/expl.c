...
u8 g_RStage15ExplosionAnimUnused[] = {1, 0x43, 0, 0};

u8* g_RStage15ExplosionAnimations[5] = {
    g_RStage15ExplosionAnimSmall,         g_RStage15ExplosionAnimFireball,
    g_RStage15ExplosionAnimSmallMultiple, g_RStage15ExplosionAnimBig,
    g_RStage15ExplosionAnimUnused,
};

u16 g_RStage15ExplosionInit[5] = {1, 2, 4, 5, 1};
u16 g_RStage15ExplosionInitPadding = 0;
