...
#define CHECK_NONE (-1)
#define FOR_RELIC(id) (0x40000000 | (id))
#define FOR_CASTLE_FLAG(id) (0x80000000 | (id))

enum BatEventCondition {
    RELIC_FORM_OF_MIST = 7,
...
enum FamiliarActiveIds {
    ...
    FAM_ACTIVE_SWORD = 5,
    FAM_ACTIVE_YOUSEI = 6,
    FAM_ACTIVE_NOSE_DEMON = 7,
};

// clang-format off
#define MAKE_EVENT(servant, roomX, roomY, camX, camY, condition, delay, entity, params) \
    { 0, 0, servant, roomX, roomY, camX, camY, condition, delay, entity, params, 1 }
#define NULL_EVENT \
...
static ServantEvent g_Events[] = {
    ...
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 21, 22, 187, 4, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 60, 26, 0, 255, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 44, 18, 791, 772, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 10, 15, 988, 4, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    ...
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 27, 21, 640, 260, FOR_CASTLE_FLAG(NO2_SECRET_WALL_OPEN), 64, E_UNK_DC, 7),
    ...
    MAKE_EVENT(FAM_ACTIVE_FAERIE, 43, 10, 0, 255, FOR_CASTLE_FLAG(NZ1_LOWER_WALL_OPEN), 128, E_UNK_DC, 10),
    ...
    MAKE_EVENT(FAM_ACTIVE_YOUSEI, 21, 22, 187, 4, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_YOUSEI, 60, 26, 0, 255, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_YOUSEI, 44, 18, 791, 772, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    MAKE_EVENT(FAM_ACTIVE_YOUSEI, 10, 15, 988, 4, FOR_RELIC(RELIC_FORM_OF_MIST), 96, E_UNK_DC, 2),
    ...
    MAKE_EVENT(FAM_ACTIVE_YOUSEI, 27, 21, 640, 260, FOR_CASTLE_FLAG(NO2_SECRET_WALL_OPEN), 64, E_UNK_DC, 7),
