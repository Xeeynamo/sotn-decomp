...
INCLUDE_ASM("asm/saturn/richter/f_nonmat", f60A6272, func_060A6272);
...
INCLUDE_ASM("asm/saturn/richter/f_nonmat", f60B052A, func_060B052A);
...
INCLUDE_ASM("asm/saturn/richter/data", d60B23B6, d_060B23B6);
