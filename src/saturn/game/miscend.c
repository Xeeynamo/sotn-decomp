...
u16 g_StatusHudPrimitiveLayout[29] = {
    ...
    0x1429, 0x142D, 0x1224, 0x1425, 0x1128, 0x1425, 0x1425, 0x192E, 0x132A,
    0x1125, 0x1429,
};
...
SaturnSpriteImage g_StatusPortraitImages[17] = {
    {32, 48, 0x0000}, {20, 8, 0x0300},  {20, 8, 0x0328},
    {12, 8, 0x0350},  {12, 8, 0x0368},  {24, 28, 0x0380},
    {20, 28, 0x0428}, {12, 28, 0x04B4}, {20, 16, 0x0508},
    {16, 16, 0x0558}, {12, 16, 0x0598}, {20, 16, 0x05C8},
    {16, 20, 0x0618}, {16, 16, 0x0668}, {16, 16, 0x06A8},
    {16, 16, 0x06E8}, {0, 0, 0x0728},
};
