...
const char* c_strALUCARD[] = {"dummy\xFF", "dummy\xFF"};
const char* c_strGOLD[] = {"dummy\xFF"};
...
const char* c_strEXP = "xxx\xFF";
const char* c_strNEXT = "xxxx\xFF";
const char* c_strLEVEL = "dummy\xFF";
const char* c_strTIME = "xxx\xFF";
const char* c_strROOMS = "dummy\xFF";
const char* c_strKILLS = "dummy\xFF";
const char* c_strHP = "xx\xFF";
const char* c_strMP = "xx\xFF";
const char* c_strHEART = "dummy\xFF";
const char* c_strSTATUS = "dummy\xFF";
const char* c_strButton = "dummy\xFF";
const char* c_strCloak = "dummy\xFF";
const char* c_strCloak2 = "dummy\xFF";
const char* c_strExterior = "dummy\xFF";
const char* c_strLining = "dummy\xFF";
const char* c_strButtonLeftHand = "dummy\xFF";
const char* c_strButtonJump = "dummy\xFF";
const char* c_strButtonSpecial = "dummy\xFF";
const char* c_strButtonWolf = "dummy\xFF";
const char* c_strButtonMist = "dummy\xFF";
const char* c_strButtonBat = "dummy\xFF";
const char* c_strNormal = "dummy\xFF";
const char* c_strReversal = "dummy\xFF";
const char* c_strSound = "dummy\xFF";
const char* c_strStereo = "dummy\xFF";
const char* c_strMono = "dummy\xFF";
const char* c_strWindow = "dummy\xFF";
const char* c_strTime = "dummy\xFF";
const char* c_strALUCART = "dummy\xFF";
const char* c_strSSword[] = {
    dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy, dummy,
};
const char* g_WingSmashComboStr = "dummy";
const char* c_strEquip = "dummy\xFF";
const char* c_strSpells = "dummy\xFF";
const char* c_strRelics = "dummy\xFF";
const char* c_strSystem = "dummy\xFF";
const char* c_strFamiliars = "dummy\xFF";
const char* c_strFamiliar = "dummy\xFF";
const char* c_strSpecial2 = "dummy\xFF";
