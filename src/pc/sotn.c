...
bool InitGame(struct InitGameParams* params) {
    ...
    g_Vram.dudes.D_800ACD98.x = 0x0380;
    g_Vram.dudes.D_800ACD98.y = 0x0180;
    g_Vram.dudes.D_800ACD98.w = 0x0010;
    g_Vram.dudes.D_800ACD98.h = 0x0001;
    g_Vram.dudes.D_800ACDA0.x = 0;
    g_Vram.dudes.D_800ACDA0.y = 0;
    g_Vram.dudes.D_800ACDA0.w = 0x0200;
    g_Vram.dudes.D_800ACDA0.h = 0x0200;
    g_Vram.dudes.D_800ACDA8.x = 0;
    g_Vram.dudes.D_800ACDA8.y = 0x00F0;
    g_Vram.dudes.D_800ACDA8.w = 0x0100;
    g_Vram.dudes.D_800ACDA8.h = 0x0010;
