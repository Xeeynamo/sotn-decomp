...
void ResetAfterImage(s32 arg0, s32 arg1);
...
bool InitGame(struct InitGameParams* params) {
    ...
    api.InitClutAnimation = InitClutAnimation;
    api.LoadGfxAsync = LoadGfxAsync;
    api.PlaySfx = PlaySfx;
    api.AllocatePrimitives = AllocatePrimitives;
    api.ResetClutAnimation = ResetClutAnimation;
    api.g_pfn_800EA5AC = SetBackgroundColor;
    ...
    api.SetPlayerBlinkTimer = SetPlayerBlinkTimer;
    api.ResetAfterImage = ResetAfterImage;
    ...
    api.ResetAfterImageCounter = ResetAfterImageCounter;
    api.UpdatePlayerStats = UpdatePlayerStats;
    ...
    api.UpdatePlayerAttributes = NULL;
    ...
    api.CalculateLuckAdjustedValue = CalculateLuckAdjustedValue;
    api.DetermineItemDrop = DetermineItemDrop;
    ...
    api.AdjustForInvertedCastle = AdjustForInvertedCastle;
