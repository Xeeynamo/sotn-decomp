...
// mtc2 30
#define gte_ldlzc(r0) MTC2(*(uint*)((char*)(r0)), 30);
...
#define gte_mvmva(sf, mx, v, cv, lm)                                           \
    gte_mvmva_core(0x0400012 | ((sf) << 19) | ((mx) << 17) | ((v) << 15) |     \
                   ((cv) << 13) | ((lm) << 10))
...
#define gte_mvmva_b(sf, mx, v, cv, lm)                                         \
    gte_mvmva_core_b(0x0400012 | ((sf) << 19) | ((mx) << 17) | ((v) << 15) |   \
                     ((cv) << 13) | ((lm) << 10))
...
// swc2 31
#define gte_stlzc(r0) *(ushort*)((char*)(r0)) = MFC2(31);
