...
template <typename T, size_t size> class FastFIFO {
  public:
    FastFIFO() {
    ...
    INLINE uint32 CanRead(void) { return in_count; }

    INLINE uint32 CanWrite(void) { return size - in_count; }

    INLINE T Peek(void) { return data[read_pos]; }
