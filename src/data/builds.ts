...
export const overlayMeta: Record<string, OverlayMeta> = {
  ...
  no3: { name: "ST/NO3/NO3.BIN", desc: "Castle Entrance (first visit)" },
  no4: { name: "ST/NO4/NO4.BIN", desc: "Underground Caverns" },
  np3: { name: "ST/NP3/NP3.BIN", desc: "Castle Entrance (second visit)" },
  nz0: { name: "ST/NZ0/NZ0.BIN", desc: "Alchemy Laboratory" },
  nz1: { name: "ST/NZ1/NZ1.BIN", desc: "Clock Tower" },
  st0: { name: "ST/ST0/ST0.BIN", desc: "Prologue" },
  ...
  rcen: { name: "ST/RCEN/RCEN.BIN", desc: "Reverse Center" },
  ...
  rno3: { name: "ST/RNO3/RNO3.BIN", desc: "Reverse Castle Entrance" },
  ...
  // Bosses
  bo0: { name: "BOSS/BO0/BO0.BIN", desc: "Boss: Olrox" },
  bo1: { name: "BOSS/BO1/BO1.BIN", desc: "Boss: Granfaloon" },
  bo2: { name: "BOSS/BO2/BO2.BIN", desc: "Boss: Minotaur and Werewolf" },
  bo3: { name: "BOSS/BO3/BO3.BIN", desc: "Boss: Scylla" },
  bo4: { name: "BOSS/BO4/BO4.BIN", desc: "Boss: Doppleganger Lv.10" },
  bo5: { name: "BOSS/BO5/BO5.BIN", desc: "Boss: Hippogryph" },
  bo6: { name: "BOSS/BO6/BO6.BIN", desc: "Boss: Richter" },
  bo7: { name: "BOSS/BO7/BO7.BIN", desc: "Boss: Cerberos" },
  mar: { name: "BOSS/MAR/MAR.BIN", desc: "Maria cutscene (clock room)" },

  // Reverse bosses
  rbo0: {
    name: "BOSS/RBO0/RBO0.BIN",
    desc: "Reverse boss: Fake Trevor / Fake Grant / Fake Sypha",
  },
  rbo1: { name: "BOSS/RBO1/RBO1.BIN", desc: "Reverse boss: Beezelbub" },
  rbo2: { name: "BOSS/RBO2/RBO2.BIN", desc: "Reverse boss: Death" },
  rbo3: { name: "BOSS/RBO3/RBO3.BIN", desc: "Reverse boss: Medusa" },
  rbo4: { name: "BOSS/RBO4/RBO4.BIN", desc: "Reverse boss: The Creature" },
  rbo5: {
    name: "BOSS/RBO5/RBO5.BIN",
    desc: "Reverse boss: Doppleganger Lv.40",
  },
  rbo6: { name: "BOSS/RBO6/RBO6.BIN", desc: "Reverse boss: Dracula" },
  rbo7: { name: "BOSS/RBO7/RBO7.BIN", desc: "Reverse boss: Akmodan II" },
  rbo8: { name: "BOSS/RBO8/RBO8.BIN", desc: "Reverse boss: Galamoth" },
  ...
  tt_006: {
    name: "SERVANT/TT_006.BIN",
    desc: "Familiar: Hana-Akuma (Fairy)",
  },
