...
u16 g_SfxScriptVolumeCopy[4];
s8 g_SfxScriptDistance[4];
s8 g_SfxScriptDistanceCopy[4];
s16 g_CurrentSfxScriptSfxId[4];
s16 g_CurrentSfxScriptSfxIdCopy[4];
u8 g_SfxScriptMode[4];
u8 g_SfxScriptModeCopy[4];
s16 g_SfxScriptTimer[4];
s16 g_SfxScriptTimerCopy[4];
s8* g_CurrentSfxScript[4];
s8* D_801390B4[4];
s16 g_CurrentSfxScriptSfxId2[4];
s16 g_SfxScriptUnk6[4];
s16 g_CurrentSfxId12_19[4];
s16 D_8013AED4[4];
