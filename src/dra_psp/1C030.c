...
INCLUDE_ASM("dra_psp/nonmatchings/1C030", HandleNowLoading);
...
INCLUDE_ASM("dra_psp/nonmatchings/1C030", MainMenuHandler);

INCLUDE_ASM("dra_psp/nonmatchings/1C030", HandleEnding);
