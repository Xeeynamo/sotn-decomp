...
INCLUDE_ASM("st/chi/nonmatchings/entity_damage_display", func_801A1474);    // [Duplicate]
...
INCLUDE_ASM("st/chi/nonmatchings/entity_damage_display", func_801A169C);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/entity_damage_display", func_801A1914);    // [Duplicate]

#include "../../alloc_entity.h"

INCLUDE_ASM("st/chi/nonmatchings/entity_damage_display", func_801A1B5C);    // [Duplicate]
