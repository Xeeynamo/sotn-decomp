...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_8019E1A0);    // UpdateStageEntities()
//#include "../update_stage_entities.h"

// POSSIBLE FILE BREAK

//#ifndef NON_MATCHING
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_8019E2A8);    // HitDetection()
//#else
// typedef struct {
//     /* 0x00 */ char pad0[0x18];
//     /* 0x18 */ ? unk18;                             // inferred
...
//#endif
//#ifndef NON_MATCHING
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_8019F3C0);    // EntityDamageDisplay()
//#else
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A05DC);    // EntityIsNearPlayer2()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A0654);    // EntityRedDoor()
//#include "../e_red_door.h"

#include "../entity.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1474);    // [Duplicate]
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A169C);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1914);    // [Duplicate]

#include "../../alloc_entity.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1B5C);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1B88);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1BA4);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1C10);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1C48);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1C90);    // [Duplicate]

#include "../adjust_value_within_threshold.h"
#include "../unk_entity_func0.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1DBC);    // [Duplicate]

#include "../get_angle_between_entities.h"
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1E24);    // [Duplicate]
#include "../get_normalized_angle.h"

#include "../set_step.h"
#include "../set_sub_step.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A1F08);    // EntityExplosionSpawn()
//#include "../entity_explosion_spawn.h"

#include "../init_entity.h"
#include "../entity_dummy.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A20C0);    // [Duplicate]

#include "../check_field_collision.h"
#include "../get_player_collision_with.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2684);    // ReplaceBreakableWithItemDrop()
//#include "../replace_breakable_with_item_drop.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A273C);    // [Duplicate]
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A27C0);    // [Duplicate]
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A291C);    // CollectHeart()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A299C);    // CollectGold()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2A78);    // CollectSubweapon()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2B90);    // CollectHeartVessel()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2C34);    // CollectLifeVessel()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2C84);    // DestroyCurrentEntity()

// POSSIBLE FILE BREAK

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A2CAC);    // EntityPrizeDrop()
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A3520);    // EntityExplosion()
//#include "../entity_explosion.h"
#include "../blink_item.h"
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A36C0);    // EntityEquipItemDrop()
//#include "../e_collect.h"

#include "../blit_char.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A3F58);    // EntityRelicOrb()
//#include "../entity_relic_orb.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A4A28);    // EntityHeartDrop()

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A4B50);    // EntityMessageBox()
//#include "../entity_message_box.h"

#include "../check_coll_offsets.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A519C);    // EntityUnkId13()
//#include "../entity_unkId13.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A52AC);    // EntityUnkId14Spawner()
//#include "../entity_unkId14_spawner.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A53DC);    // EntityUnkId15Spawner()
//#include "../entity_unkId15_spawner.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A54C4);    // EntityUnkId14()
//#include "../entity_unkId14.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A55B4);    // EntityUnkId15()
//#include "../entity_unkId15.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A56A8);    // EntityOlroxDrool()
//#include "../entity_olrox_drool.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A58D8);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A59D4);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A5F54);    // EntityIntenseExplosion()
//#include "../entity_intense_explosion.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A6054);    // [Duplicate]
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A61E8);    // [Duplicate]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A62A0);    // EntityBigRedFireball()
//#include "../entity_big_red_fireball.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A6478);    // UnkRecursivePrimFunc1()
//#include "../unk_recursive_primfunc_1.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A6A58);    // UnkRecursivePrimFunc2()
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A7448);    // EntitySoulStealOrb()
//#include "../entity_soul_steal_orb.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A77DC);    // EntityEnemyBlood()
//#include "../entity_enemy_blood.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A7C8C);    // EntityRoomForeground()
//#include "../e_room_fg.h"

#include "../bottom_corner_text.h"

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A80A8);

// POSSIBLE FILE BREAK

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A813C);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A8DE8);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A8EAC);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A93D4);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A9588);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A97C8);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A9D40);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801A9E94);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AA020);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AA390);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AB0C0);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AB548);

// POSSIBLE FILE BREAK

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AB7CC);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AC074);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AC730);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801ACB6C);    // [Entity]

INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801ACEF4);    // [Entity]
...
//#ifndef NON_MATCHING
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AD2BC);    // EntityStageNamePopup()
//#else
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801ADF40);    // UnkPrimHelper()
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE328);    // UpdateAnimation()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE478);    // FindFirstUnkPrim()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE4A8);    // FindFirstUnkPrim2()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE524);    // PrimToggleVisibility()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE5AC);    // PrimResetNext()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE68C);    // UnkPolyFunc2()
...
//INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE6E0);    // UnkPolyFunc0()
...
INCLUDE_ASM("st/chi/nonmatchings/1D1A8", func_801AE70C);    // PrimDecreaseBrightness()
