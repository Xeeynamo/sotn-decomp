...
#ifndef NON_MATCHING
//INCLUDE_ASM("st/chi/nonmatchings/2813C", func_801A813C);    // [Entity]
//#else
s32 AnimateEntity(u8*, Entity*);
void CreateEntityFromCurrentEntity(u16, Entity*);
s32 GetDistanceToPlayerX();
s32 GetDistanceToPlayerY();
s32 GetSideToPlayer();
void SetStep(u8);
void SetSubStep(u8);
...
void func_801A813C(Entity* self)
{
    ...
    switch (self->step) {
        ...
        case 0xFF:
            FntPrint(&D_8019B280, self->animCurFrame);
