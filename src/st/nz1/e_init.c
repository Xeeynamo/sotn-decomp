...
EInit g_EInitSkullLord = {ANIMSET_OVL(3), 1, 76, PAL_ROOM_EXIT0, 0x105};
EInit g_EInitSkullLordEffects = {ANIMSET_OVL(3), 1, 76, PAL_ROOM_EXIT0, 0x005};
EInit g_EInitHarpy = {ANIMSET_OVL(4), 0, 76, PAL_ROOM_EXIT6, 0x0EF};
EInit g_EInitHarpyDagger = {ANIMSET_OVL(4), 18, 76, PAL_ROOM_EXIT6, 0x0F1};
EInit g_EInitHarpyFlame = {ANIMSET_OVL(4), 19, 76, PAL_ROOM_EXIT6, 0x0F2};
EInit g_EInitHarpyKick = {ANIMSET_OVL(4), 0, 76, PAL_ROOM_EXIT6, 0x0F0};
EInit g_EInitHarpyFeather = {ANIMSET_OVL(4), 24, 76, PAL_ROOM_EXIT6, 0x002};
EInit g_EInitCloakedKnight = {ANIMSET_OVL(5), 1, 72, PAL_ROOM_EXITA, 0x10F};
EInit g_EInitCloakedKnightAura = {ANIMSET_OVL(5), 1, 72, PAL_ROOM_EXITA, 0x002};
EInit g_EInitCloakedKnightSword = {ANIMSET_OVL(5), 1, 72, PAL_ROOM_EXITA, 0x110};
EInit g_EInitSwordLord = {ANIMSET_OVL(6), 1, 80, PAL_ROOM_EXITF, 0x009};
EInit g_EInitSwordLordAttack = {ANIMSET_DRA(0), 0, 0, PAL_NONE, 0x00A};
EInit g_EInitVandalSword = {ANIMSET_OVL(6), 40, 80, PAL_ROOM_EXITF, 0x0E4};
EInit g_EInitVandSwordDeath = {ANIMSET_OVL(6), 40, 80, PAL_ROOM_EXITF, 0x002};
...
EInit g_EInitFlailGuard = {ANIMSET_OVL(7), 1, 74, PAL_UNK_220, 0x044};
EInit g_EInitFlailGuardFlail = {ANIMSET_OVL(7), 17, 74, PAL_UNK_220, 0x045};
