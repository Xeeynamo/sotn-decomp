...
EInit D_us_80180C48 = {ANIMSET_OVL(7), 18, 74, PAL_UNK_220, 0x043};
EInit D_us_80180C54 = {ANIMSET_OVL(7), 18, 74, PAL_UNK_220, 0x002};
...
EInit D_us_80180C84 = {ANIMSET_DRA(0), 0, 0, PAL_NONE, 0x02A};
EInit D_us_80180C90 = {ANIMSET_OVL(8), 0, 72, PAL_UNK_223, 0x028};
EInit D_us_80180C9C = {ANIMSET_OVL(11), 0, 72, PAL_UNK_232, 0x118};
EInit D_us_80180CA8 = {ANIMSET_OVL(11), 59, 72, PAL_UNK_232, 0x119};
EInit D_us_80180CB4 = {ANIMSET_OVL(11), 0, 72, PAL_UNK_232, 0x11A};
EInit D_us_80180CC0 = {ANIMSET_OVL(11), 0, 72, PAL_UNK_232, 0x11B};
EInit D_us_80180CCC = {ANIMSET_OVL(11), 63, 72, PAL_UNK_232, 0x002};
EInit D_us_80180CD8 = {ANIMSET_OVL(12), 0, 86, PAL_UNK_238, 0x12F};
EInit D_us_80180CE4 = {ANIMSET_OVL(12), 0, 86, PAL_UNK_239, 0x130};
// clang-format on
