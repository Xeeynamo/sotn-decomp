...
s32 E_ID(WALL_GEAR);
s32 E_ID(PENDULUM_ANCHOR);
s32 E_ID(PENDULUM_BONE_CHAIN);
s32 E_ID(PENDULUM_WEIGHT);
...
s32 E_ID(SKULL_LORD_FLAMES);
s32 E_ID(SKULL_LORD_PIECES);
s32 E_ID(HARPY);
s32 E_ID(HARPY_DAGGER);
s32 E_ID(HARPY_FLAME);
s32 E_ID(HARPY_KICK);
s32 E_ID(HARPY_FEATHER);
s32 E_ID(CLOAKED_KNIGHT);
s32 E_ID(CLOAKED_KNIGHT_CLOAK);
s32 E_ID(CLOAKED_KNIGHT_SWORD);
s32 E_ID(CLOAKED_KNIGHT_AURA);
s32 E_ID(SWORD_LORD);
s32 E_ID(SWORD_LORD_ATTACK_HITBOX);
s32 E_ID(VANDAL_SWORD);
s32 E_ID(VANDAL_SWORD_DEATH);
s32 E_ID(VANDAL_SWORD_HITBOX);
s32 E_ID(PHANTOM_SKULL);
s32 E_ID(PHANTOM_SKULL_TRAIL);
s32 E_ID(FLAIL_GUARD);
s32 E_ID(FLAIL_GUARD_FLAIL);
...
s32 E_ID(BOSS_DOORS);
s32 E_ID(KARASUMAN);
s32 E_ID(KARASUMAN_FEATHER_ATTACK);
s32 E_ID(KARASUMAN_ORB_ATTACK);
s32 E_ID(KARASUMAN_RAVEN_ATTACK);
s32 E_ID(KARASUMAN_FEATHER);
s32 E_ID(KARASUMAN_RAVEN_ABSORB);
