...
static s32 E_ID(WATER_SPRAY);
static s32 E_ID(ICE_PLATFORM);
...
static s32 E_ID(BREAKABLE_WALL);
...
void InitEntityIds(void) {
    ...
    E_ID(WATER_SPRAY) = 0x37;
    E_ID(ICE_PLATFORM) = 0x38;
    E_ID(ID_39) = 0x39;
    E_ID(ID_3A) = 0x3A;
