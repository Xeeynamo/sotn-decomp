...
static s16 D_us_80181094[][4] = {
    {0x0A0, 0x020, 0x50, 0x20}, {0x010, 0x020, 0x80, 0x20},
    {0x000, 0x030, 0x50, 0x20}, {0x0A0, 0x0B0, 0x50, 0x20},
    {0x010, 0x020, 0x30, 0x20}, {0x050, 0x020, 0x60, 0x20},
    {0x0C0, 0x020, 0x30, 0x20},
};
