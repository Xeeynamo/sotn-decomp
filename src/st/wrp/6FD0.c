...
void EntityWarpRoom(Entity* arg0) {
    ...
    case 0:
        ...
        var_s0 = 0;
        temp_s5 = arg0->posY.Data.high; // must not be lhu but lh
        temp_s4 = arg0->posX.Data.high; // must not be lhu but lh
        ...
        *(s32*)&temp_s2->r3 = *(s32*)&temp_s2->r0;
        ...
        for (i = 0; i < 0x20; i++) {
            ...
            if (newEntity) {
                ...
                newEntity->posY.Data.high = 0xCC - D_80073092;
                newEntity->posX.Data.high = (Random() & 0x7F) + 0x40;
            }
        }
        arg0->unk3C = 1;
        arg0->hitboxWidth = 2;
        ...
        *(u32*)D_80180648 = 0;
        ...
        if ((u32)(
                (GET_PLAYER(g_EntityArray)->posX.Data.high + (s16)D_8007308E) -
                0x61) < 0x3F) {
            D_80072EFC = 0x10;
            D_80072EF4 = 0;
            D_8003C8B8 = 0;
