...
//
// early version of src/st/e_collect.c
...
u8* g_SubweaponAnimPrizeDrop[] = {
    ...
    D_80180D08, D_80180D18, D_80180D1C, D_80180D1C, D_80180D1C, D_80180D30,
    D_80180D1C, D_80180D1C, D_80180D1C, D_80180D1C, D_80180D1C,
};
...
void CollectDummy2(void) { DestroyEntity(g_CurrentEntity); }
...
void EntityDropUnused(Entity* self) {
    if (self->step != 0) {
