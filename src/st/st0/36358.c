...
s32 func_801B56BC(Entity*, Entity*); /* extern */
...
void EntityAbsorbOrb(Entity* self) {
    ...
    case 0:
        ...
        if (temp_b & 0xFFFF) {
            self->ext.absorbOrb.angle = angle - D_80181F54[Random() & 7];
        } else {
