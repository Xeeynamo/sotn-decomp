...
static SVECTOR D_801821C8[] = {
    {0, -182, 65, 0},  {0, -182, -65, 0}, {-65, -99, -65, 0},
    {-65, -99, 65, 0}, {65, -99, 65, 0},  {65, -99, -65, 0},
};
static SVECTOR D_801821F8[] = {
    {82, -163, -82, 0}, {65, -99, -99, 0}, {65, -99, -65, 0},
    {99, -99, -99, 0},  {99, -99, -65, 0},
};
static SVECTOR D_80182220[] = {
    {83, -163, 82, 0}, {66, -99, 66, 0}, {66, -99, 99, 0},
    {99, -99, 66, 0},  {99, -99, 99, 0},
};
static SVECTOR D_80182248[] = {
    {-83, -163, -82, 0}, {-99, -99, -99, 0}, {-99, -99, -65, 0},
    {-66, -99, -99, 0},  {-66, -99, -65, 0},
};
static SVECTOR D_80182270[] = {
    {-82, -163, 82, 0}, {-99, -99, 65, 0}, {-99, -99, 99, 0},
    {-65, -99, 65, 0},  {-65, -99, 99, 0},
};
static SVECTOR D_80182298[] = {
    {-99, 83, 99, 0},  {-99, -100, 99, 0}, {-99, -100, -99, 0},
    {-99, 83, -99, 0}, {99, -100, -99, 0}, {99, 83, -99, 0},
    {99, -100, 99, 0}, {99, 83, 99, 0},
};
static SVECTOR D_801822D8[] = {
    {-99, 83, 99, 0},  {-99, 83, -99, 0},  {99, 83, -99, 0},  {99, 83, 99, 0},
    {-65, 116, 65, 0}, {-65, 116, -65, 0}, {65, 116, -65, 0}, {65, 116, 65, 0},
};
static SVECTOR D_80182318[] = {
    {-65, 283, 65, 0},  {-65, 116, 65, 0}, {-65, 116, -65, 0},
    {-65, 283, -65, 0}, {65, 116, -65, 0}, {65, 283, -65, 0},
    {65, 116, 65, 0},   {65, 283, 65, 0},
};
static SVECTOR D_80182358[] = {
    {-65, 450, 65, 0},  {-65, 283, 65, 0}, {-65, 283, -65, 0},
    {-65, 450, -65, 0}, {65, 283, -65, 0}, {65, 450, -65, 0},
    {65, 283, 65, 0},   {65, 450, 65, 0},
};
u8 D_80182398[] = {
