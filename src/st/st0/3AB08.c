...
static SVECTOR D_801821C8[] = {
    {0x0000, 0xFF4A, 0x0041, 0x0000}, {0x0000, 0xFF4A, 0xFFBF, 0x0000},
    {0xFFBF, 0xFF9D, 0xFFBF, 0x0000}, {0xFFBF, 0xFF9D, 0x0041, 0x0000},
    {0x0041, 0xFF9D, 0x0041, 0x0000}, {0x0041, 0xFF9D, 0xFFBF, 0x0000},
};
static SVECTOR D_801821F8[] = {
    {0x0052, 0xFF5D, 0xFFAE, 0x0000}, {0x0041, 0xFF9D, 0xFF9D, 0x0000},
    {0x0041, 0xFF9D, 0xFFBF, 0x0000}, {0x0063, 0xFF9D, 0xFF9D, 0x0000},
    {0x0063, 0xFF9D, 0xFFBF, 0x0000},
};
static SVECTOR D_80182220[] = {
    {0x0053, 0xFF5D, 0x0052, 0x0000}, {0x0042, 0xFF9D, 0x0042, 0x0000},
    {0x0042, 0xFF9D, 0x0063, 0x0000}, {0x0063, 0xFF9D, 0x0042, 0x0000},
    {0x0063, 0xFF9D, 0x0063, 0x0000},
};
static SVECTOR D_80182248[] = {
    {0xFFAD, 0xFF5D, 0xFFAE, 0x0000}, {0xFF9D, 0xFF9D, 0xFF9D, 0x0000},
    {0xFF9D, 0xFF9D, 0xFFBF, 0x0000}, {0xFFBE, 0xFF9D, 0xFF9D, 0x0000},
    {0xFFBE, 0xFF9D, 0xFFBF, 0x0000},
};
static SVECTOR D_80182270[] = {
    {0xFFAE, 0xFF5D, 0x0052, 0x0000}, {0xFF9D, 0xFF9D, 0x0041, 0x0000},
    {0xFF9D, 0xFF9D, 0x0063, 0x0000}, {0xFFBF, 0xFF9D, 0x0041, 0x0000},
    {0xFFBF, 0xFF9D, 0x0063, 0x0000},
};
static SVECTOR D_80182298[] = {
    {0xFF9D, 0x0053, 0x0063, 0x0000}, {0xFF9D, 0xFF9C, 0x0063, 0x0000},
    {0xFF9D, 0xFF9C, 0xFF9D, 0x0000}, {0xFF9D, 0x0053, 0xFF9D, 0x0000},
    {0x0063, 0xFF9C, 0xFF9D, 0x0000}, {0x0063, 0x0053, 0xFF9D, 0x0000},
    {0x0063, 0xFF9C, 0x0063, 0x0000}, {0x0063, 0x0053, 0x0063, 0x0000},
};
static SVECTOR D_801822D8[] = {
    {0xFF9D, 0x0053, 0x0063, 0x0000}, {0xFF9D, 0x0053, 0xFF9D, 0x0000},
    {0x0063, 0x0053, 0xFF9D, 0x0000}, {0x0063, 0x0053, 0x0063, 0x0000},
    {0xFFBF, 0x0074, 0x0041, 0x0000}, {0xFFBF, 0x0074, 0xFFBF, 0x0000},
    {0x0041, 0x0074, 0xFFBF, 0x0000}, {0x0041, 0x0074, 0x0041, 0x0000},
};
static SVECTOR D_80182318[] = {
    {0xFFBF, 0x011B, 0x0041, 0x0000}, {0xFFBF, 0x0074, 0x0041, 0x0000},
    {0xFFBF, 0x0074, 0xFFBF, 0x0000}, {0xFFBF, 0x011B, 0xFFBF, 0x0000},
    {0x0041, 0x0074, 0xFFBF, 0x0000}, {0x0041, 0x011B, 0xFFBF, 0x0000},
    {0x0041, 0x0074, 0x0041, 0x0000}, {0x0041, 0x011B, 0x0041, 0x0000},
};
static SVECTOR D_80182358[] = {
    {0xFFBF, 0x01C2, 0x0041, 0x0000}, {0xFFBF, 0x011B, 0x0041, 0x0000},
    {0xFFBF, 0x011B, 0xFFBF, 0x0000}, {0xFFBF, 0x01C2, 0xFFBF, 0x0000},
    {0x0041, 0x011B, 0xFFBF, 0x0000}, {0x0041, 0x01C2, 0xFFBF, 0x0000},
    {0x0041, 0x011B, 0x0041, 0x0000}, {0x0041, 0x01C2, 0x0041, 0x0000},
};
u8 D_80182398[] = {
