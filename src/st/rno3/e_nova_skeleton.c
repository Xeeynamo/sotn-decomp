...
INCLUDE_ASM("st/rno3/nonmatchings/e_nova_skeleton", func_us_801C2740);

INCLUDE_ASM("st/rno3/nonmatchings/e_nova_skeleton", func_us_801C27E0);

INCLUDE_RODATA("st/rno3/nonmatchings/e_nova_skeleton", D_us_801B013C);

INCLUDE_ASM("st/rno3/nonmatchings/e_nova_skeleton", EntityNovaSkeleton);

INCLUDE_ASM("st/rno3/nonmatchings/e_nova_skeleton", EntityBladeSoldierDeathParts);
