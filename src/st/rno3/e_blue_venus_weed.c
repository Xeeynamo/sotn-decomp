...
INCLUDE_ASM("st/rno3/nonmatchings/e_blue_venus_weed", SetupPrimsForEntitySpriteParts);
...
INCLUDE_ASM("st/rno3/nonmatchings/e_blue_venus_weed", EntityVenusWeedSpike);
