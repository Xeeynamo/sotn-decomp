...
EInit OVL_EXPORT(EInitBreakable) = {ANIMSET_DRA(3), 0, 0, 0x0, 0x000};
EInit OVL_EXPORT(EInitObtainable) = {ANIMSET_DRA(3), 0, 0, 0x0, 0x001};
EInit OVL_EXPORT(EInitParticle) = {ANIMSET_DRA(3), 0, 0, 0x0, 0x002};
EInit OVL_EXPORT(EInitSpawner) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x004};
EInit OVL_EXPORT(EInitInteractable) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x005};
EInit OVL_EXPORT(EInitUnkId13) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x002};
EInit OVL_EXPORT(EInitLockCamera) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x001};
EInit OVL_EXPORT(EInitCommon) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x003};
EInit OVL_EXPORT(EInitDamageNum) = {ANIMSET_DRA(0), 0, 0, 0x0, 0x003};
EInit g_EInitUnused80180938 = {ANIMSET_OVL(1), 0, 0, 0x0, 0x005};
EInit g_EInitStInteractable = {ANIMSET_OVL(2), 0, 0, 0x0, 0x005};
EInit g_EInitFireWarg1 = {ANIMSET_OVL(3), 1, 75, 0x200, 0x094};
EInit g_EInitFireWarg2 = {ANIMSET_OVL(3), 1, 75, 0x200, 0x097};
EInit g_EInitFireWarg3 = {ANIMSET_DRA(0), 0, 75, 0x200, 0x096};
EInit g_EInitJackOBones = {ANIMSET_OVL(4), 1, 74, 0x20c, 0x074};
EInit g_EInitJackOBones2 = {ANIMSET_OVL(4), 0, 74, 0x20c, 0x002};
EInit g_EInitJackOBones3 = {ANIMSET_OVL(4), 21, 74, 0x20c, 0x075};
EInit g_EInitNovaSkeleton = {ANIMSET_OVL(5), 1, 72, 0x214, 0x07E};
EInit g_EInitNovaSkeleton2 = {ANIMSET_OVL(5), 0, 72, 0x214, 0x07F};
EInit g_EInitOrobourous = {ANIMSET_OVL(6), 1, 81, 0x231, 0x08D};
EInit g_EInitOruburos = {ANIMSET_OVL(6), 4, 81, 0x231, 0x08E};
EInit g_EInitOruburosHead = {ANIMSET_OVL(6), 4, 81, 0x231, 0x002};
EInit g_EInitOruburosRider = {ANIMSET_OVL(6), 4, 81, 0x231, 0x08F};
EInit g_EInitDragonRider1 = {ANIMSET_OVL(6), 1, 80, 0x231, 0x090};
EInit g_EInitDragonRider2 = {ANIMSET_OVL(6), 4, 80, 0x231, 0x091};
EInit g_EInitDragonRiderHead = {ANIMSET_OVL(6), 4, 80, 0x231, 0x002};
EInit g_EInitVenusWeedRoot = {ANIMSET_OVL(7), 0, 80, 0x240, 0x188};
EInit g_EInitVenusWeedFlower = {ANIMSET_OVL(7), 0, 80, 0x240, 0x189};
EInit g_EInitVenusWeedTendril = {ANIMSET_OVL(7), 0, 80, 0x240, 0x18A};
EInit g_EInitVenusWeedDart = {ANIMSET_OVL(7), 55, 80, 0x240, 0x18B};
EInit D_us_80180A34 = {ANIMSET_OVL(1), 0, 0, 0x0, 0x005};
EInit D_us_80180A40 = {ANIMSET_OVL(2), 0, 0, 0x0, 0x005};
EInit g_EInitDodoBird = {ANIMSET_OVL(8), 1, 82, 0x26a, 0x068};
// clang-format on
