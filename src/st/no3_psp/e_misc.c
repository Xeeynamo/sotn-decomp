...
INCLUDE_ASM("st/no3_psp/psp/no3_psp/e_misc", EntityRelicOrb);

INCLUDE_ASM("st/no3_psp/psp/no3_psp/e_misc", EntityHeartDrop);

INCLUDE_ASM("st/no3_psp/psp/no3_psp/e_misc", EntityMessageBox);
