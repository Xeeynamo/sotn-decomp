...
static u16 mermanRockTiles2[] = {
    0x02A7, 0x0287, 0x02B4, 0x02A8, 
    0x02AE, 0x02B5, 0x06DB, 0x06DC, 
    0x06DD, 0x06B7, 0x0000, 0x06C6,
    // Index 12
    0x06B6, 0x06B8, 0x06B9, 0x06B7, 
    0x0000, 0x06C6, 0,           0,
    0x0000, 0x0000, 0x0000, 0x0350, 
    0x032F, 0x034E, 
    // Index 26
    0x0332, 0x033A, 0x0351, 0x0350, 
    0x032F, 0x034E, 0x02D2, 0x02D2, 
    0x02D2, 0x02D2, 0x02D2, 0x02D2, 
    0x02D2, 0x02D2, 0x02D2, 0x02D2, 
    0x02D6, 0x02D4, 0x02D6, 0x02D8, 
    0x02D7, 
    // Index 47
    0x06BA, 0x0000, 0x0000, 0x06BD, 
    0x06BF, 0x06BB, 0x0000, 0x0000, 
    0x06BE, 0x06C0, 0x06BC, 0x0000, 
    0x0000, 0x06BD, 0x06C1, 0x0000, 
    0x0000, 0x0000, 0,           0, 
    0x0000, 0x0000, 0x0000, 0x0000, 
    0x0000, 0x0000, 0x0000, 0x0350, 
    0x0000, 0x034E, 0x0339, 0x0000, 
    // Index 79
...
void EntityMermanRockRightSide(Entity* self) {
    ...
    case 0:
        ...
        tileLayoutPtr = &mermanRockTiles2[26];
        tilePos = 0x1FD;
        for (i = 0; i < 3; i++, tileLayoutPtr++) {
            g_BgLayers[0].layout[tilePos] = *tileLayoutPtr;
            *(&g_BgLayers[0].layout[tilePos] + 1) = *(tileLayoutPtr + 3);
        ...
        if (g_CastleFlags[JEWEL_SWORD_ROOM_STEPS] & rockBroken) {
            tilePos = 0x1FD;
            tileLayoutPtr = &mermanRockTiles2[12];
            for (i = 0; i < 3; i++, tileLayoutPtr++) {
                g_Tilemap.fg[tilePos] = *tileLayoutPtr;
                *(&g_Tilemap.fg[tilePos] + 1) = *(tileLayoutPtr + 3);
                tilePos += 0x30;
