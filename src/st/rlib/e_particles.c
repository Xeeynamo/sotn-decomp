...
extern u16 D_us_80181644[];
extern s16 D_us_80181654[];
extern u8 D_us_801816B4[];
...
void EntitySoulStealOrb(Entity* self) {
    ...
    case 1:
        ...
        AnimateEntity(D_us_801816B4, self);
        prim->tpage = 0x18;
        prim->clut = PAL_UNK_194;
        angle = self->animCurFrame;
        angle = (angle - 1) << 3;

        spr = &D_us_80181654[angle];
