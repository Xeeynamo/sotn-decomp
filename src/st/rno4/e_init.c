...
EInit g_EInitBlueVenusWeedTendril = {ANIMSET_OVL(7), 0, 80, 564, 0x18A};
EInit g_EInitBlueVenusWeedDart = {ANIMSET_OVL(7), 55, 80, 564, 0x18B};
...
EInit g_EInitRockKnightDebris = {ANIMSET_OVL(5), 0, 76, 552, 0x002};
EInit g_EInitRockKnightProjectile = {ANIMSET_OVL(5), 65, 76, 552, 0x0A8};
...
EInit g_EInitNovaLaser = {ANIMSET_OVL(11), 0, 72, 532, 0x07F};
