...
static char D_psp_092A4BB8[] = {0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0xFF, 0x00};

static char D_psp_092A4BC8[] = {0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D};

static RECT D_psp_092A4BD0 = {.x = 0, .y = 0x100, .w = 0x100, .h = 0x100};

static char D_psp_092A4BD8[] = {0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0xFF, 0x00, 0x00};

static RECT D_psp_092A4BE8 = {.x = 0, .y = 0x100, .w = 0x100, .h = 0x100};

static u16 D_psp_092A4BF0[] = {0x1000, 0x0800, 0x8000, 0x4000, 0x2000, 0x0400, 0x0200, 0x0080, 0x0100, 0x0040, 0x0020};

static char D_psp_092A4C08[] = {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

static char* D_psp_092A4C18[] = {D_psp_092A4C08};

static char D_psp_092A4C20[] = {0x1F, 0x1F, 0x1F, 0x1F, 0xFF, 0x00, 0x00, 0x00};

static char* D_psp_092A4C28[] = {D_psp_092A4C20};

static char D_psp_092A4C30[] = {0xB5, 0xB7, 0xB1, 0xD5, 0x00, 0xD8, 0xAE, 0xB3, 0xC0, 0xDB, 0xB3, 0xFF, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C40[] = {0xD4, 0xC5, 0xC0, 0xFF, 0x9E, 0x00, 0xB7, 0xD6, 0xD5, 0xB7, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C50[] = {0xD6, 0xBA, 0xD4, 0xCF, 0x00, 0xC1, 0xBB, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C60[] = {0xDC, 0xB6, 0xD3, 0xC4, 0x00, 0xC9, 0xD8, 0xB5, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C70[] = {0xCC, 0xB6, 0xD0, 0x00, 0xD8, 0xB6, 0xFF, 0x00};
static char D_psp_092A4C78[] = {0xBB, 0xC4, 0xB3, 0x00, 0xCF, 0xBB, 0xCA, 0xD9, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C88[] = {0xBC, 0xB2, 0xC5, 0x00, 0xCD, 0xB7, 0xD9, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static char D_psp_092A4C98[] = {0xD4, 0xC5, 0xD0, 0x00, 0xBC, 0xFF, 0x9E, 0xAE, 0xB3, 0xBC, 0xFF, 0x9E, 0xFF, 0x00, 0x00, 0x00};
static char* D_psp_092A4CA8[] = {D_psp_092A4C30, D_psp_092A4C40, D_psp_092A4C50, D_psp_092A4C60, D_psp_092A4C70, D_psp_092A4C78, D_psp_092A4C88, D_psp_092A4C98};

static char D_psp_092A4CC8[] = {0x95, 0xBD, 0x90, 0xAC, 0x82, 0x56, 0x94, 0x4E, 0x82, 0x57, 0x8C, 0x8E, 0x82, 0xC9, 0x8E, 0xFB, 0x98, 0x5E, 0x82, 0xB3, 0x82, 0xEA, 0x82, 0xBD, 0x82, 0xE0, 0x82, 0xCC, 0x82, 0xC5, 0x82, 0xB7, 0x81, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

static u16 D_us_80181978[] = {0x0345, 0x0344, 0x0348, 0x0347, 0x0342, 0x0346, 0x0343, 0x0349};

static RECT D_psp_092A4D00 = {.x = 0, .y = 0x100, .w = 0x100, .h = 0x100};

static u16 D_psp_092A4D08[] = {0x0321, 0x031F, 0x032F, 0x030F, 0x032B, 0x030D, 0x0313, 0x033C, 0x0309, 0x0315, 0x031D, 0x033B, 0x0305, 0x030B, 0x0319, 0x0307, 0x033A, 0x0301, 0x0317, 0x0303, 0x032D, 0x0323, 0x0311, 0x0325, 0x031B, 0x0331, 0x0333, 0x0335, 0x0337, 0x0339, 0x0000, 0x0000};
