...
static char* D_psp_092A0AF0[] = {
    ...
    _SE("Unzerstörbarer Wirbelschﾎdel."),
    "Frische Leichen.",
    "Vampirfledermﾎuse.",
...
static char* D_psp_092A14D0[] = {
    ...
    "",
    "Magisch beseelt.",
    _SE("Gefｨrchtete Diener des Bösen."),
    "Schloss bewachen.",
    "",
    "Greift alle Eindringlinge an.",
    "Trieft vor Gift.",
    "schwertkﾎmpfer.",
    _SE("Gröﾊter Wassergeist."),
    "",
    "",
...
static char* D_psp_092A44F0[] = {
    ...
    "Enthﾎlt ”Geisterruf”",           _SE("Enthﾎlt ”Höllenfeuer”"),
