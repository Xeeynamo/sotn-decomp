...
static char* D_psp_0929B4A0[] = {
    ...
    _S3("Brujas fantasma de Sálem."),
    "Busca entre las tumbas y",
    _S3("Guardián con cabeza de pez."),
...
static char* D_psp_0929BFF0[] = {
    ...
    "",
    "",
    _S3("cabezas. ｳCuál es la cabeza?"),
    "",
    ...
    "con sﾚlida armadura.",
    _S3("Fuerte en áreas peligrosas."),
    "Lleva una ropera.",
    "",
    "",
    "",
...
static char* D_psp_092A2A88[] = {
    _S3("Mapa básico del castillo."), "Contiene ”Metamorfosis oscura”",
