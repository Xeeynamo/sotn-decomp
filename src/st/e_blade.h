...
static s16 D_8018358C[] = {
    0x000,  0x000,  0x080, -0x100, 0x000, 0x000,  0x000,
...
static s16 D_80183770[] = {
    0x100,  -0x240, 0x200, -0x100, 0x000, 0x000,  -0x1C0,
    -0x100, -0x300, 0x100, 0x000,  0x180, -0x500, -0x480};
static s16 D_8018378C[] = {
    0x180,  -0x240, 0x280, -0x100, 0x000, 0x000,  -0x1C0,
    -0x100, -0x300, 0x100, 0x000,  0x180, -0x500, -0x480};
...
static s16 D_801839A8[] = {
    0x000,  -0x200, 0x080, -0x200, -0x200, -0x200, 0x000,
    -0x100, -0x040, 0x100, 0x000,  0x200,  -0x500, -0x400};
...
static s16 D_801839E0[] = {
    0x000,  -0x400, 0x080, -0x400, -0x400, -0x400, -0x100,
...
void EntityBladeSword(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        InitializeEntity(g_EInitBladeSword);
