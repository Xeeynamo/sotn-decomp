...
INCLUDE_ASM("st/nz0_psp/nonmatchings/nz0_psp/unk_3B70", BoxPuzzleFloorButton);

INCLUDE_ASM("st/nz0_psp/nonmatchings/nz0_psp/unk_3B70", BoxPuzzleSpikes);

INCLUDE_ASM("st/nz0_psp/nonmatchings/nz0_psp/unk_3B70", EntityMovableBox);

INCLUDE_ASM("st/nz0_psp/nonmatchings/nz0_psp/unk_3B70", EntityFloorButton);
