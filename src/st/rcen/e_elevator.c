...
static AnimateEntityFrame D_us_80180A3C[] = {
    POSE(8, 0x03, 0), POSE(4, 0x04, 0),  POSE(4, 0x05, 0), POSE(4, 0x06, 0),
    POSE(4, 0x07, 0), POSE(4, 0x08, 0),  POSE(4, 0x09, 0), POSE(2, 0x0A, 0),
    POSE(1, 0x0B, 0), POSE(16, 0x0A, 0), POSE_END,
};

static AnimateEntityFrame D_us_80180A54[] = {
    POSE(4, 0x0A, 0), POSE(4, 0x09, 0), POSE(4, 0x08, 0), POSE(4, 0x07, 0),
    POSE(4, 0x06, 0), POSE(4, 0x05, 0), POSE(4, 0x04, 0), POSE(4, 0x03, 0),
    POSE(2, 0x0C, 0), POSE(4, 0x03, 0), POSE_END,
};
...
void EntityElevatorStationary(Entity* self) {
    ...
    case 1:
        playerIsTouching = (self - 2)->ext.cenElevator.playerCollision;
        if (playerIsTouching) {
            posX = self->posX.i.hi - player->posX.i.hi;
            if (g_pads[0].pressed & PAD_DOWN && abs(posX) < 8) {
#ifdef VERSION_PSP
    ...
    case 2:
        ...
        case 0:
            ...
            break;
        case 1:
            if (!AnimateEntity(D_us_80180A54, self)) {
                self->pose = 0;
                self->poseTimer = 0;
