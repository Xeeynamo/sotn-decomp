...
static AnimateEntityFrame D_us_80180A3C[] = {
    {0x08, 0x03}, {0x04, 0x04}, {0x04, 0x05}, {0x04, 0x06},
    {0x04, 0x07}, {0x04, 0x08}, {0x04, 0x09}, {0x02, 0x0A},
    {0x01, 0x0B}, {0x10, 0x0A}, POSE_END,
};

static AnimateEntityFrame D_us_80180A54[] = {
    {0x04, 0x0A}, {0x04, 0x09}, {0x04, 0x08}, {0x04, 0x07},
    {0x04, 0x06}, {0x04, 0x05}, {0x04, 0x04}, {0x04, 0x03},
    {0x02, 0x0C}, {0x04, 0x03}, POSE_END,
};
