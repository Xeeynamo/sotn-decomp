...
static s16 unused[] = {-3, -3, 0, 0, 3, -3, 0, 0, -3, 3, 0, 0, 3, 3, 0, 0};
static SVECTOR emptySVec = {.vx = 0, .vy = 0, .vz = 0};

static void func_us_801D4E30(void) {
    Primitive* prim;
    s32 i;
...
static void func_us_801D4E94(s32 arg0) {
    s32 angle;
    s32 i;
    s32 xOffset;
    s32 yOffset;
...
static void func_us_801D4FCC(void) {
    s32 i;
    s32 xOffset;
    s32 yOffset;
...
static void func_us_801D5074(s32 arg0) {
    Primitive* nextPrim;
    Primitive* prim;
    Point32* pos;
    s32 posX;
...
static void func_us_801D51EC(void) {
    Primitive* prim;
    s32 i;
...
static s32 func_us_801D52E0(void) {
    Entity* tempEntity;
    s32 angle;
    s32 dx;
    s32 dy;
...
static void func_us_801D5384(void) {
    Collider collider;
    Primitive* prim;
    Point32* tempPoint32;
    s32 posX;
...
void func_us_801D542C(Entity* self) {
    ...
    case 9:
        ...
        tempEntity = self - 2;
        if (!self->ext.plateLordUnknown.unk9D) {
        ...
        attack = (tempEntity->ext.plateLordUnknown.unk84 *
                 ...
                 8;
        if (attack > g_api.enemyDefs[98].attack) {
