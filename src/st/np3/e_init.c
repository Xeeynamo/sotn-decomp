...
u16 g_EInitObtaineable[] = {0x0003, 0x0000, 0x0000, 0x0000, 0x0001};
u16 g_EInitParticle[] = {0x0003, 0x0000, 0x0000, 0x0000, 0x0002};
u16 D_80180A60[] = {0x0000, 0x0000, 0x0000, 0x0000, 0x0004};
u16 g_EInitInteracteable[] = {0x0000, 0x0000, 0x0000, 0x0000, 0x0005};
...
u16 g_EInitStInteracteable[] = {0x8001, 0x0000, 0x0000, 0x0000, 0x0005};
