...
EInit OVL_EXPORT(EInitBreakable) = {ANIMSET_DRA(0x03), 0x00, 0x00, 0x000, 0x000};
...
EInit g_EInitSlograProjectileNP3 = {ANIMSET_OVL(0x0A), 0x00, 0x48, 0x2D9, 0x0F5};
EInit g_EInitGaibonNP3 = {ANIMSET_OVL(0x0B), 0x00, 0x4C, 0x2E2, 0x0FE};
EInit g_EInitGaibonProjectileNP3 = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x0FF};
EInit g_EInitGaibonLargeProjectileNP3 = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x100};
