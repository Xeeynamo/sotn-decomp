...
EInit OVL_EXPORT(EInitInteractable) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x005};
EInit OVL_EXPORT(EInitUnkId13) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x002};
EInit OVL_EXPORT(EInitLockCamera) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x001};
EInit OVL_EXPORT(EInitCommon) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x003};
EInit OVL_EXPORT(EInitDamageNum) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x003};
...
EInit g_EInitHammer = {ANIMSET_OVL(0x0C), 0x02, 0x4C, 0x2F0, 0x0BA};
EInit g_EInitHammerWeapon = {ANIMSET_OVL(0x0C), 0x12, 0x4C, 0x2F0, 0x0BB};
