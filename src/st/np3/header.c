...
static u16** Clut[] = {
    ...
    PAL_BULK(0xD00, D_801963B4),
    PAL_BULK(0x2000, D_80194914),
    PAL_BULK(0x28C0, D_80195A94),
    ...
    PAL_BULK(0x2C80, D_801961B4),
    PAL_BULK(0x2CB0, D_801962D4),
    PAL_BULK(0x2D30, D_80196214),
    PAL_BULK(0x2D60, D_80196274),
    PAL_BULK(0x2D90, D_80196674),
    PAL_BULK(0x2E20, D_801966D4),
    PAL_BULK(0x2EA0, D_801967D4),
    PAL_TERMINATE(),
};
