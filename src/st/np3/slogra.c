...
static u8 D_80181328[] = {7, 1, 5, 10, 22, 11, 2, 12, 2, 13, 2, 14, 2, 15, 65, 14, 255, 0};
static u8 unused_anim[] = {24, 14, 6, 13, 5, 31, 34, 1, 255, 0};
static u8 D_80181348[] = {3, 16, 3, 17, 1, 18, 1, 19, 1, 18, 1, 19, 1, 18, 24, 19, 255, 0};
static u8 D_8018135C[] = {3, 16, 3, 17, 3, 18, 1, 21, 1, 20, 1, 21, 1, 20, 1, 21, 40, 20, 255, 0};
static u8 D_80181370[] = {9, 22, 8, 23, 12, 24, 10, 23, 0};
static u8 D_8018137C[] = {7, 22, 7, 25, 7, 26, 17, 22, 0};
static u8 D_80181388[] = {3, 27, 3, 28, 1, 21, 1, 20, 1, 21, 1, 20, 1, 21, 24, 20, 255, 0};
static u8 D_8018139C[] = {5, 25, 5, 26, 5, 27, 5, 28, 7, 20, 14, 21, 5, 27, 2, 30, 1, 29, 1, 30, 50, 29, 255, 0};
...
static s8 D_801813EC[] = {0, 0, 0, 0, -8, 2, 19, 27, -12, 6, 19, 24, -11, 6, 19, 24, -7, 2, 19, 27, 0, 2, 19, 27, -82, -96, 0, 0, -27, 13, 32, 11, -9, 2, 19, 27, -85, -97, 0, 0, -4, 18, 8, 32, 0, 0, 7, 4, 1, 1, 4, 11, 2, 1, 7, 7, 2, 1, 9, 4, 3, 1, 7, 5};
static u8 D_8018142C[] = {0, 1, 1, 1, 1, 1, 2, 3, 2, 2, 4, 5, 1, 1, 2, 2, 5, 5, 5, 5, 5, 5, 1, 1, 1, 4, 4, 1, 1, 7, 7, 8, 8, 8, 8, 9, 1, 1, 0, 0};
static s8 D_80181454[] = {0, 0, 0, 0, -36, 12, 8, 5, -36, 11, 8, 5, -51, -5, 19, 6, -49, -5, 19, 6, -33, 12, 7, 4, -27, 8, 7, 4, -34, 13, 7, 4, -40, 16, 10, 4, -52, -5, 19, 6, -82, -96, 0, 0, -36, 14, 7, 4, -36, 16, 7, 4, -4, 18, 4, 32};
static u8 D_8018148C[] = {0, 0, 0, 0, 0, 0, 3, 4, 3, 3, 0, 0, 0, 0, 9, 9, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 0, 0, 0, 0, 0, 13, 13, 0, 0};
