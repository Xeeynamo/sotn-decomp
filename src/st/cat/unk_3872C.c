...
void func_us_801B87E8(Entity* arg0) {
    ...
    if (arg0->step == 0) {
        ...
        arg0->flags = FLAG_KEEP_ALIVE_OFFCAMERA | FLAG_HAS_PRIMS;
        ...
        while (prim_1 != 0) {
            ...
            prim_1->u3 = 0x3F;
            prim_1->v3 = 0xDE;
            prim_1->drawMode = DRAW_UNK02;
            temp_2 = ((u16)prim_1->y0) - (-0x5F);
            prim_1->y2 = temp_2;
            prim_1->y3 = temp_2;
            if (g_CastleFlags[0x42] == 0) {
                prim_1->drawMode = DRAW_HIDE | DRAW_COLORS | DRAW_UNK02;
            }
            prim_1 = prim_1->next;
            cntr++;
        }
        ...
        while (prim_1 != 0) {
            ...
            if (arg0->ext.ILLEGAL.u8[5] != 0) {
                if (prim_1->r0 > 0x7f) {
                    ...
                    *((u32*)(((char*)prim_1) + 0x10)) =
                        *((u32*)(((char*)prim_1) + 4));
                    *((u32*)(((char*)prim_1) + 0x1c)) =
                        *((u32*)(((char*)prim_1) + 4));
                    *((u32*)(((char*)prim_1) + 0x28)) =
                        *((u32*)(((char*)prim_1) + 4));
                }
            }
