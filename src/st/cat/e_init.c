...
// Common
EInit OVL_EXPORT(EInitBreakable) = {ANIMSET_DRA(3), 0x00, 0x00, 0x0000, 0x000};
...
EInit OVL_EXPORT(EInitSpawner) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x004};
EInit OVL_EXPORT(EInitInteractable) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x005};
EInit OVL_EXPORT(EInitUnkId13) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x002};
EInit OVL_EXPORT(EInitLockCamera) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x001};
EInit OVL_EXPORT(EInitCommon) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x003};
EInit OVL_EXPORT(EInitDamageNum) = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x0000, 0x003};
