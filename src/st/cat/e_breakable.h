...
static u8 explosion_types[] = {
    ...
    EXPLOSION_SMALL_MULTIPLE, EXPLOSION_SMALL_MULTIPLE};
static u16 palettes[] = {
    PAL_NULL,      PAL_NULL,      PAL_NULL,      PAL_BREAKABLE, PAL_BREAKABLE,
    PAL_BREAKABLE, PAL_BREAKABLE, PAL_BREAKABLE, PAL_BREAKABLE, PAL_BREAKABLE};
#ifdef INVERTED_STAGE
static u16 anim_sets[] = {
    ANIMSET_OVL(8), ANIMSET_OVL(8), ANIMSET_OVL(8), ANIMSET_OVL(6),
    ANIMSET_OVL(6), ANIMSET_OVL(6), ANIMSET_OVL(6), ANIMSET_OVL(6),
    ANIMSET_OVL(6), ANIMSET_OVL(6), ANIMSET_OVL(6), ANIMSET_OVL(2)};
#else
static u16 anim_sets[] = {
