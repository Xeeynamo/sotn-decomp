    ...
    if (saveDescriptorString > 0) {
        if (g_SaveSummary[port].padding == -3 || saveDescriptorString == 3) {
            ...
            DrawString16x16(D_psp_091CE1F8, sp4c, y + 0x78, 1);
                   ...
                   ((port == 0) &&
                    g_SaveSummary[port].slot[slot] == GetQuickSaveDataSlot())) {
...
void OVL_EXPORT(Update)(void) {
    ...
    case Upd_Eng_50:
        ...
        } else if (GetQuickSaveDataSlot() == -1) {
            ...
            if (g_pads[0].tapped & PAD_START) {
                ...
                if (var_s4 == 8) {
                    ...
                    if (g_SaveSummary[D_801D6B04 / 15].slot[D_801D6B04 % 15] ==
                        GetQuickSaveDataSlot()) {
                        quickSaveSlot = ClearQuickSaveDataSlot();
                    }
                }
            }
        }
    ...
    case Upd_Eng_257:
        ...
        if (temp_s1 == 1) {
            if (g_SaveSummary[D_801D6B04 / 15].slot[D_801D6B04 % 15] ==
                ...
                quickSaveSlot = ClearQuickSaveDataSlot();
                func_psp_08919770(3);
                SetQuickSaveDataSlot(quickSaveSlot);
            } else {
                D_psp_08B42044 = 1;
                D_8003C730 = 1;
            }
