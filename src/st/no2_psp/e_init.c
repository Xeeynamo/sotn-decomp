...
EInit D_pspeu_09266648 = {ANIMSET_DRA(0x00), 0x00, 0x00, 0x000, 0x004};
...
EInit D_pspeu_092666C8 = {ANIMSET_OVL(0x02), 0x0B, 0x00, 0x000, 0x003};
EInit D_pspeu_092666D8 = {ANIMSET_OVL(0x03), 0x01, 0x49, 0x203, 0x003};
...
EInit D_pspeu_09266728 = {ANIMSET_OVL(0x02), 0x0E, 0x00, 0x000, 0x005};
EInit D_pspeu_09266738 = {ANIMSET_OVL(0x05), 0x01, 0x4C, 0x207, 0x085};
EInit D_pspeu_09266748 = {ANIMSET_OVL(0x05), 0x01, 0x4C, 0x207, 0x003};
EInit D_pspeu_09266758 = {ANIMSET_OVL(0x00), 0x00, 0x00, 0x000, 0x086};
EInit D_pspeu_09266768 = {ANIMSET_OVL(0x00), 0x00, 0x00, 0x000, 0x087};
EInit D_pspeu_09266778 = {ANIMSET_OVL(0x06), 0x02, 0x4C, 0x23E, 0x0BA};
EInit D_pspeu_09266788 = {ANIMSET_OVL(0x06), 0x12, 0x4C, 0x23E, 0x0BB};
EInit D_pspeu_09266798 = {ANIMSET_OVL(0x06), 0x02, 0x4C, 0x23B, 0x0BC};
EInit D_pspeu_092667A8 = {ANIMSET_OVL(0x06), 0x14, 0x4C, 0x23B, 0x0BD};
EInit D_pspeu_092667B8 = {ANIMSET_OVL(0x06), 0x02, 0x4C, 0x238, 0x0BE};
EInit D_pspeu_092667C8 = {ANIMSET_OVL(0x06), 0x13, 0x4C, 0x238, 0x0BF};
EInit D_pspeu_092667D8 = {ANIMSET_OVL(0x04), 0x00, 0x50, 0x241, 0x081};
EInit D_pspeu_092667E8 = {ANIMSET_OVL(0x04), 0x00, 0x50, 0x241, 0x002};
EInit D_pspeu_092667F8 = {ANIMSET_OVL(0x04), 0x00, 0x50, 0x241, 0x082};
