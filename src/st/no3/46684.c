...
void EntityAbsorbOrb(Entity* self) {
    ...
    case 0:
        ...
        if (temp_b & 0xFFFF) {
            self->ext.absorbOrb.angle = angle - D_801826D0[Random() & 7];
        } else {
