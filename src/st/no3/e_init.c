...
EInit D_80180B30 = {0x8006, 1, 0x48, 0x2cb, 151};
EInit D_80180B3C = {0x0, 0, 0x48, 0x2cb, 150};
EInit g_EInitWaterObject = {0x8003, 1, 0x48, 0x28c, 29};
EInit g_EInitWaterSplash = {0x8003, 0, 0x48, 0x28c, 30};
EInit D_80180B60 = {0x8004, 1, 0x4a, 0x2b2, 27};
EInit D_80180B6C = {0x8004, 0, 0x4a, 0x2b2, 28};
...
EInit D_80180B9C = {0x8006, 7, 0x48, 0x2d0, 175};
EInit D_80180BA8 = {0x8007, 0, 0x4d, 0x2d3, 110};
