...
EInit D_80180B24 = {0x8006, 1, 0x48, 0x2cb, 148};
EInit D_80180B30 = {0x8006, 1, 0x48, 0x2cb, 151, 0, 0, 0};
EInit D_80180B3C = {0x0, 0, 0x48, 0x2cb, 150, 0, 0, 0};
EInit g_EInitWaterObject = {0x8003, 1, 0x48, 0x28c, 29, 0, 0, 0};
EInit g_EInitWaterSplash = {0x8003, 0, 0x48, 0x28c, 30, 0, 0, 0};
EInit D_80180B60 = {0x8004, 1, 0x4a, 0x2b2, 27, 0, 0, 0};
EInit D_80180B6C = {0x8004, 0, 0x4a, 0x2b2, 28, 0, 0, 0};
EInit g_EInitBoneScimitar = {0x8002, 1, 0x48, 0x2c5, 105, 0, 0, 0};
EInit g_EInitScimitarParts = {0x8002, 1, 0x48, 0x2c5, 2, 0, 0, 0};
EInit g_EInitBat = {0x8005, 0, 0x4c, 0x2c8, 64, 0, 0, 0};
EInit D_80180B9C = {0x8006, 7, 0x48, 0x2d0, 175, 0, 0, 0};
EInit D_80180BA8 = {0x8007, 0, 0x4d, 0x2d3, 110, 0, 0, 0};
