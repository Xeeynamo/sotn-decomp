...
EInit g_EInitLesserDemon = {ANIMSET_OVL(6), 1, 76, 0x22D, 0x017};
EInit g_EInitLesserDemonSpit = {ANIMSET_OVL(6), 25, 76, 0x22D, 0x019};
EInit g_EInitLesserDemonFireball = {ANIMSET_DRA(9), 1, 0, 0x81B0, 0x01A};
EInit g_EInitLesserDemonDummy = {ANIMSET_DRA(0), 0, 0, PAL_NULL, 0x018};
EInit g_EInitWallDebris = {ANIMSET_OVL(1), 0, 0, PAL_NULL, 0x003};
EInit OVL_EXPORT(EInitEnemy3) = {ANIMSET_OVL(2), 0, 0, PAL_NULL, 0x003};
...
EInit g_EInitImp = {ANIMSET_OVL(11), 1, 95, 0x260, 0x11C};
EInit g_EInitImpSmoke = {ANIMSET_OVL(11), 1, 95, 0x260, 0x002};
EInit g_EInitGremlin = {ANIMSET_OVL(12), 0, 94, 0x270, 0x0E1};
EInit g_EInitGremlinUnused = {ANIMSET_OVL(12), 0, 94, 0x270, 0x005};
