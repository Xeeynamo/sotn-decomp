...
EInit D_us_80180990 = {ANIMSET_DRA(3), 0,  0, PAL_NULL, 0x001};
...
EInit D_us_801809D8 = {ANIMSET_DRA(0), 0,  0, PAL_NULL, 0x003};
...
EInit D_us_80180A74 = {ANIMSET_OVL(2), 0,  0, PAL_NULL, 0x003};
