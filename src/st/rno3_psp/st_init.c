...
void InitEntityIds(void) {
    ...
    E_ID(FIRE_WARG_WAVE_ATTACK) = E_FIRE_WARG_WAVE_ATTACK;
    E_ID(UNK_ID2F) = E_UNK_ID2F;
    E_ID(UNK_ID30) = E_UNK_ID30;
    E_ID(UNK_ID31) = E_UNK_ID31;
    E_ID(EXPLOSION3) = E_EXPLOSION3;
    E_ID(FIRE_WARG_DEATH_BEAMS) = E_FIRE_WARG_DEATH_BEAMS;
    ...
    E_ID(PATH_BLOCK_SMALL_WEIGHT) = E_PATH_BLOCK_SMALL_WEIGHT;
    ...
    E_ID(FALLING_ROCK2) = E_FALLING_ROCK2;
