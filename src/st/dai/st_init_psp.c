...
static void InitEntityIds(void) {
    ...
    E_ID(BONE_PILLAR_SKULL) = 0x29;
    E_ID(BONE_PILLAR_FIRE) = 0x2A;
    E_ID(BONE_PILLAR_PARTS) = 0x2B;
    ...
    E_ID(BONE_HALBERD_ATTACK) = 0x33;
    E_ID(BONE_HALBERD_PARTS) = 0x34;
    E_ID(WINGED_GUARD) = 0x35;
    E_ID(WINGED_GUARD_PARTS) = 0x36;
    E_ID(BAT) = 0x37;
    ...
    E_ID(SPECTRAL_SWORD) = 0x3F;
    E_ID(SPECTRAL_SWORD_AURA) = 0x40;
    E_ID(SPECTRAL_SWORD_WEAPON) = 0x41;
