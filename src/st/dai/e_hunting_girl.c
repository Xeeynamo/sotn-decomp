...
enum HuntingGirlSubsteps {
    HUNTING_GIRL_IDLE_INIT = 0,
    HUNTING_GIRL_IDLE_PULSE = 1,
    HUNTING_GIRL_IDLE_FADE = 2,
    HUNTING_GIRL_RECOVER_INIT = 0,
    HUNTING_GIRL_RECOVER_FADE_IN = 1,
    HUNTING_GIRL_RECOVER_FADE_OUT = 2,
    HUNTING_GIRL_ATTACK_INIT = 0,
    HUNTING_GIRL_ATTACK_FADE_IN = 1,
    HUNTING_GIRL_ATTACK_FADE_OUT = 2,
    HUNTING_GIRL_ATTACK_DRAW = 3,
    HUNTING_GIRL_TRANSITION_POS = 0,
    HUNTING_GIRL_TRANSITION_TURN = 1,
    HUNTING_GIRL_HIT_INIT = 0,
    HUNTING_GIRL_HIT_KNOCKBACK = 1,
    HUNTING_GIRL_HIT_FADE = 2,
    HUNTING_GIRL_DEATH_INIT = 0,
    HUNTING_GIRL_DEATH_KNOCKBACK = 1,
    HUNTING_GIRL_DEATH_FADE = 2,
    HUNTING_GIRL_DEATH_EXPLODE = 3,
};
