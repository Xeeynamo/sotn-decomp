...
EInit D_us_80180A58 = {ANIMSET_OVL(9), 0, 74, PAL_BAT, 64};
EInit D_us_80180A64 = {ANIMSET_OVL(10), 0, 79, PAL_UNK22F, 114};
EInit D_us_80180A70 = {ANIMSET_OVL(10), 0, 79, PAL_UNK22F, 115};
EInit D_us_80180A7C = {ANIMSET_OVL(11), 1, 72, PAL_UNK200, 11};
EInit D_us_80180A88 = {ANIMSET_OVL(11), 43, 72, PAL_UNK200, 12};
