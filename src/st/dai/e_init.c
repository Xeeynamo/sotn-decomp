...
// Unused, not in psp
EInit g_EInit_801809A4 = {ANIMSET_OVL(1), 43, 72, PAL_DRA(0x200), 3};
EInit D_us_801809B0 = {ANIMSET_OVL(1), 0, 0, PAL_DRA(0), 5};
EInit D_us_801809BC = {ANIMSET_OVL(2), 0, 72, PAL_DRA(0xC9), 5};
// Unused, not in psp
EInit g_EInit_801809C8 = {ANIMSET_OVL(2), 0, 72, PAL_DRA(0xCA), 5};
EInit D_us_801809D4 = {ANIMSET_OVL(2), 37, 72, PAL_DRA(0xC9), 101};
EInit D_us_801809E0 = {ANIMSET_OVL(4), 0, 72, PAL_DRA(0x215), 180};
EInit D_us_801809EC = {ANIMSET_OVL(0), 0, 0, PAL_DRA(0), 181};
EInit D_us_801809F8 = {ANIMSET_OVL(5), 0, 73, PAL_DRA(0x216), 183};
EInit D_us_80180A04 = {ANIMSET_OVL(5), 0, 73, PAL_DRA(0x216), 2};
EInit D_us_80180A10 = {ANIMSET_OVL(5), 0, 73, PAL_DRA(0x216), 184};
EInit D_us_80180A1C = {ANIMSET_OVL(5), 0, 73, PAL_DRA(0x216), 185};
EInit D_us_80180A28 = {ANIMSET_OVL(7), 1, 72, PAL_DRA(0x22A), 118};
EInit D_us_80180A34 = {ANIMSET_OVL(0), 0, 0, PAL_DRA(0), 119};
EInit D_us_80180A40 = {ANIMSET_OVL(8), 0, 75, PAL_DRA(0x22B), 128};
EInit D_us_80180A4C = {ANIMSET_OVL(8), 0, 75, PAL_DRA(0x22B), 3};
EInit D_us_80180A58 = {ANIMSET_OVL(9), 0, 74, PAL_DRA(0x22C), 64};
EInit D_us_80180A64 = {ANIMSET_OVL(10), 0, 79, PAL_DRA(0x22F), 114};
EInit D_us_80180A70 = {ANIMSET_OVL(10), 0, 79, PAL_DRA(0x22F), 115};
EInit D_us_80180A7C = {ANIMSET_OVL(11), 1, 72, PAL_DRA(0x200), 11};
EInit D_us_80180A88 = {ANIMSET_OVL(11), 43, 72, PAL_DRA(0x200), 12};
EInit D_us_80180A94 = {ANIMSET_OVL(12), 0, 84, PAL_DRA(0x232), 227};
EInit D_us_80180AA0 = {ANIMSET_OVL(13), 0, 81, PAL_DRA(0x234), 136};
EInit D_us_80180AAC = {ANIMSET_OVL(13), 0, 81, PAL_DRA(0x234), 2};
EInit D_us_80180AB8 = {ANIMSET_OVL(13), 0, 81, PAL_DRA(0x235), 137};
