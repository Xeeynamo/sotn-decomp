...
s32 E_ID(ARMOR_LORD);
s32 E_ID(ARMOR_LORD_SWORD_SHADOW);
s32 E_ID(ARMOR_LORD_FIRE_WAVE);
s32 E_ID(ARMOR_LORD_UNK2);
s32 E_ID(ARMOR_LORD_UNUSED);
s32 E_ID(FLOOR_TRAP);
s32 E_ID(THORNWEED);
s32 E_ID(CORPSEWEED);
...
void InitEntityIds(void) {
    ...
    E_ID(ARMOR_LORD_SWORD_SHADOW) = E_ARMOR_LORD_SWORD_SHADOW;
    E_ID(ARMOR_LORD_FIRE_WAVE) = E_ARMOR_LORD_FIRE_WAVE;
    E_ID(ARMOR_LORD_UNK2) = E_ARMOR_LORD_UNK2;
    E_ID(ARMOR_LORD_UNUSED) = E_ARMOR_LORD_UNUSED;
