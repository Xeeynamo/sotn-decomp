...
static AnimateEntityFrame anim_unused1[] = {
    {1, 1}, {4, 27}, {4, 28}, {1, 1}, POSE_END};
// Slightly slower squat, note that the frames are all the same, just an extra
// 4,27.
static AnimateEntityFrame anim_unused2[] = {
    {1, 1}, {4, 27}, {4, 28}, {4, 27}, {1, 1}, POSE_END};
static AnimateEntityFrame anim_idle[] = {
    {4, 1}, {5, 27}, {15, 28}, {6, 27}, {6, 1}, POSE_LOOP(0)};
static AnimateEntityFrame anim_laser_charge[] = {
    {16, 1}, {3, 2},  {3, 7},  {3, 8},  {2, 9},  {2, 10}, {2, 11},
    {2, 10}, {2, 11}, {2, 12}, {2, 11}, {2, 12}, {2, 13}, {2, 12},
    {2, 13}, {2, 14}, {2, 13}, {2, 14}, {2, 13}, {2, 14}, {2, 15},
    {2, 16}, {2, 15}, {2, 16}, {2, 15}, {2, 16}, {4, 20}, {4, 19},
    {4, 18}, {4, 17}, {4, 18}, {4, 19}, POSE_END};
