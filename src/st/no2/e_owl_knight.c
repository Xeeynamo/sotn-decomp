...
// Owl Knight shows up one slot above it
...
#define HELPER (self + 3)
    ...
    case 4:
        ...
        case 0:
            ...
            break;
        case 1:
            HELPER->posX.i.hi = dx + self->posX.i.hi;
            HELPER->posY.i.hi = dy + self->posY.i.hi;
            angle = GetAngleBetweenEntitiesShifted(self, HELPER);
            self->ext.owl.unk84 =
    ...
    case 6:
        ...
        case 2:
            ...
            dx = HELPER->posX.i.hi - self->posX.i.hi;
            dy = HELPER->posY.i.hi - self->posY.i.hi;
            if (dx > 0) {
                self->facingLeft = 1;
            } else {
                self->facingLeft = 0;
