...
INCLUDE_ASM("st/rno0/nonmatchings/e_misc", CheckColliderOffsets);
...
INCLUDE_ASM("st/rno0/nonmatchings/e_misc", MakeExplosions);
...
INCLUDE_ASM("st/rno0/nonmatchings/e_misc", ClutLerp);

INCLUDE_ASM("st/rno0/nonmatchings/e_misc", PlaySfxPositional);
