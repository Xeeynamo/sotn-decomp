...
static cloudData data[] = {
    {.unkPtr = D_us_80181334, .unk4 = 0xFF20, .priority = 0x1C},
    {.unkPtr = D_us_80181374, .unk4 = 0xFF00, .priority = 0x18},
    {.unkPtr = D_us_801813B4, .unk4 = 0x0060, .priority = 0x1C}};
