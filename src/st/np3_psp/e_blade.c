...
INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_801CE04C);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_801CE120);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_801CE1E8);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_801CE228);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", polarPlacePartsList);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_pspeu_092614A8);

INCLUDE_ASM("st/np3_psp/nonmatchings/np3_psp/e_blade", func_801CE3FC);
