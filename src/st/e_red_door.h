...
void OVL_EXPORT(EntityRedDoor)(Entity* self) {
    ...
    case 0:
#ifdef STAGE_IS_NO1
        self->ext.no1RedDoor.unk88 = self->params & 0x10;
        self->params &= 0xFFEF;
#endif
...
#ifdef STAGE_IS_NO1
            if (self->ext.no1RedDoor.unk88 && self->step == 3) {
...
#ifdef STAGE_IS_NO1
        if (PLAYER.posX.i.hi < 0x64 && self->ext.no1RedDoor.unk88) {
            g_Tilemap.left++;
            g_PlayerX -= 0x100;
            g_Tilemap.x = 0x100;
