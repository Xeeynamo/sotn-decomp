...
void func_us_801B87E8(Entity* self) {
    ...
    _unused = 0xDC;
    g_CastleFlags[RCAT_SPIKE_ROOM_LIT] = true;
    ...
    if (!self->step) {
        ...
        // nb. this is a bit unnecessary since
        // g_CastleFlags[RCAT_SPIKE_ROOM_LIT] is already hardcoded to true
        self->ext.et_801B87E8.unk80 = true;
    } else {
