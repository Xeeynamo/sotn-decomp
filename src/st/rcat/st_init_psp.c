...
s32 E_ID(GREY_PUFF);
s32 E_ID(LAVA);
s32 E_ID(CAVERN_BACKGROUND_ICE);
s32 E_ID(CAVERN_BACKGROUND_ICE_BRIDGE);
s32 E_ID(SNOWFLAKES);
s32 E_ID(SPIKES);
...
s32 E_ID(UNK_20);
s32 E_ID(UNK_21);
s32 E_ID(FROZEN_HALF);
s32 E_ID(FROZEN_HALF_ORBIT_ICICLE);
s32 E_ID(FROZEN_HALF_THROWN_CHUNK);
s32 E_ID(FROZEN_HALF_BLIZZARD);
s32 E_ID(FROZEN_HALF_FALLING_ICE);
s32 E_ID(FROZEN_HALF_FROST_MIST);
s32 E_ID(SALOME);
s32 E_ID(SALOME_EFFECTS);
s32 E_ID(SALOME_MAGIC_ORB);
s32 E_ID(SALOME_SKULL);
s32 E_ID(SALOME_CAT);
s32 E_ID(SECRET_WALL_RIGHT);
...
void InitEntityIds(void) {
    ...
    E_ID(LAVA) = E_LAVA;
    E_ID(CAVERN_BACKGROUND_ICE) = E_CAVERN_BACKGROUND_ICE;
    E_ID(CAVERN_BACKGROUND_ICE_BRIDGE) = E_CAVERN_BACKGROUND_ICE_BRIDGE;
    E_ID(SNOWFLAKES) = E_SNOWFLAKES;
    ...
    E_ID(FROZEN_HALF) = E_FROZEN_HALF;
    E_ID(FROZEN_HALF_ORBIT_ICICLE) = E_FROZEN_HALF_ORBIT_ICICLE;
    E_ID(FROZEN_HALF_THROWN_CHUNK) = E_FROZEN_HALF_THROWN_CHUNK;
    E_ID(FROZEN_HALF_BLIZZARD) = E_FROZEN_HALF_BLIZZARD;
    E_ID(FROZEN_HALF_FALLING_ICE) = E_FROZEN_HALF_FALLING_ICE;
    E_ID(FROZEN_HALF_FROST_MIST) = E_FROZEN_HALF_FROST_MIST;
    E_ID(SALOME) = E_SALOME;
    E_ID(SALOME_EFFECTS) = E_SALOME_EFFECTS;
    E_ID(SALOME_MAGIC_ORB) = E_SALOME_MAGIC_ORB;
    E_ID(SALOME_SKULL) = E_SALOME_SKULL;
    E_ID(SALOME_CAT) = E_SALOME_CAT;
    E_ID(SECRET_WALL_RIGHT) = E_SECRET_WALL_RIGHT;
