...
static s16 D_us_80182268[][4] = {{0x03E, 0x101, 0x001, 0x000}, {0x03F, 0x106, 0x006, 0x000}, {0x040, 0x020, 0x008, 0x106}};
static AnimationFrame D_us_80182280[] = {{2, 2}, {2, 3}, {0, 0}};
static AnimationFrame D_us_8018228C[] = {{2, 2}, {3, 3}, {2, 2}, {2, 3}, {2, 2}, {2, 3}, {2, 2}, {16, 3}, {48, 2}, {-1, 0}};
static AnimationFrame D_us_801822B4[] = {{2, 2}, {3, 3}, {3, 2}, {4, 3}, {4, 2}, {5, 3}, {5, 2}, {5, 3}, {5, 2}, {5, 3}, {5, 2}, {5, 3}, {5, 2}, {5, 3}, {5, 2}, {5, 3}, {5, 2}, {16, 3}, {-1, 0}};
static AnimationFrame D_us_80182300[] = {{5, 8}, {5, 7}, {5, 6}, {5, 5}, {5, 4}, {0, 0}};
static AnimationFrame D_us_80182318[] = {{4, 10}, {4, 11}, {0, 0}};
static u16 D_us_80182324[] = {0, 2, 4, 6, 8, 6, 4, 2, 0, -2, -4, -6, -8, -6, -2};
