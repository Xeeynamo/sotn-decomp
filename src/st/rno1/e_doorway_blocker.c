...
static u16 wallTiles[] = {0x002B, 0x002C, 0x0023, 0x01BC, 0x0001, 0x0002, 
                              0x0023, 0x001C, 0x0003, 0x0004, 0x0023, 0x0024, 
                              0x0029, 0x002A, 0x0023, 0x001C, 0x002B, 0x002C, 
                              0x0023, 0x0024, 0x0001, 0x0002, 0x0023, 0x00A2};
static u16 unusedWallTiles[] = { 
                              0x002B, 0x002C, 0x00FA, 0x01BC, 0x01D8, 0x01D9, 
                              0x01DA, 0x01DB, 0x01DC, 0x01DD, 0x01DE, 0x01DF, 
                              0x01E7, 0x01E8, 0x01E9, 0x01EA, 0x01EB, 0x01EC, 
                              0x01ED, 0x01EE, 0x0001, 0x0002, 0x009E, 0x00A2};
