...
INCLUDE_ASM("st/rno1/nonmatchings/e_nova_skeleton", DrawLaserRing);

INCLUDE_RODATA("st/rno1/nonmatchings/e_nova_skeleton", D_us_801A5DDC);

INCLUDE_ASM("st/rno1/nonmatchings/e_nova_skeleton", EntityNovaSkeleton);
...
INCLUDE_ASM("st/rno1/nonmatchings/e_nova_skeleton", EntityNovaLaser);

INCLUDE_ASM("st/rno1/nonmatchings/e_nova_skeleton", EntityNovaLaserPulse);
