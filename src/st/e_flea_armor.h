...
static AnimateEntityFrame D_us_80182D78[] = {
    ...
    {.duration = 10, .pose = 0x02},
    POSE_LOOP(0)};
static AnimateEntityFrame D_us_80182D84[] = {
    {.duration = 2, .pose = 0x04},
    {.duration = 2, .pose = 0x05},
    {.duration = 2, .pose = 0x06},
    POSE_LOOP(0)};
static s16 D_us_80182D8C[] = {0, 16, 0, 4, 8, -4, -16, 0};
static s16 D_us_80182D9C[] = {0, 16, 8, 0};
static Point32 D_us_80182DA4[] = {
    {FIX(0.5), FIX(-4.0)},    {FIX(0.75), FIX(-5.0)},
    {FIX(-0.25), FIX(-4.75)}, {FIX(-0.8125), FIX(-4.5)},
    {FIX(-1.0), FIX(-5.125)}, {FIX(0.0), FIX(-6.0)},
};

static Point16 hitbox_offsets[] = {
    {.x = 0x0000, .y = 0x0000},
    {.x = 0xFFF2, .y = 0x0011},
};
static Size16 hitbox_dimensions[] = {
    {.width = 0, .height = 0},
    {.width = 7, .height = 11},
};
...
void EntityFleaArmorAttackHitbox(Entity* self) {
    ...
    self->hitboxOffX = hitbox_offsets[animCurFrame].x;
    self->hitboxOffY = hitbox_offsets[animCurFrame].y;
    self->hitboxWidth = hitbox_dimensions[animCurFrame].width;
    self->hitboxHeight = hitbox_dimensions[animCurFrame].height;
