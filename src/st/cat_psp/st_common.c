...
INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", GetDistanceToPlayerX);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", GetDistanceToPlayerY);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", GetSideToPlayer);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", MoveEntity);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", FallEntity);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", UnkCollisionFunc3);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", UnkCollisionFunc2);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", AllocEntity);
...
INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", SetStep);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", SetSubStep);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", InitializeEntity);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", EntityDummy);

INCLUDE_ASM("st/cat_psp/nonmatchings/cat_psp/st_common", UnkCollisionFunc);
