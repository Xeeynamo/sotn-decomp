...
INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_misc", EntityIntenseExplosion);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_misc", MakeEntityFromId);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_misc", PlaySfxPositional);
