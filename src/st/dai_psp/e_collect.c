...
INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectHeart);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectGold);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectSubweapon);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectHeartVessel);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectLifeVessel);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", CollectDummy);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", EntityPrizeDrop);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", EntityExplosion);

INCLUDE_ASM("st/dai_psp/nonmatchings/dai_psp/e_collect", BlinkItem);
