...
void func_us_801BB984(Entity* self) {
    ...
    case 1:
        if (g_CastleFlags[NO1_ELEVATOR_ACTIVATED]) {
            ...
            } else if (dx < 0x20 && OVL_EXPORT(GetDistanceToPlayerY)() < 0x10) {
...
void func_us_801BBD90(Entity* self) {
    ...
    switch (self->step) {
    case 0:
        OVL_EXPORT(InitializeEntity)(D_us_801809F8);
        self->animCurFrame = 0;
        break;
...
#define PLAYER_STATUS_ELEVATOR_READY_MASK                                      \
    ~(PLAYER_STATUS_UNK20000000 | PLAYER_STATUS_UNK10000000 |                  \
      ...
      PLAYER_STATUS_UNK100000 | PLAYER_STATUS_INVINCIBLE |                     \
      PLAYER_STATUS_CROUCH)
...
void func_us_801BCB34(Entity* self) {
    ...
    case 2:
        self->velocityY = 0;
        if (OVL_EXPORT(GetDistanceToPlayerX)() < 6 &&
            OVL_EXPORT(GetDistanceToPlayerY)() < 16) {
            i = g_Player.status;
    ...
    case 3:
        ...
        if (OVL_EXPORT(AnimateEntity)(D_us_80181550, self) == 0) {
    ...
    case 6:
        ...
        case 1:
            ...
            if (OVL_EXPORT(AnimateEntity)(D_us_8018155C, self) == 0) {
                self->pose = 0;
                self->poseTimer = 0;
                self->step_s++;
            }
