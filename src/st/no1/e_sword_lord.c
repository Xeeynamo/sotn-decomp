...
static u8 D_us_80182A9C[] = {15, 1, 10, 2, 10, 3, 13, 4, 10, 3, 10, 2, 0, 0};
...
static u8 D_us_80182B00[] = {40, 1, 4, 5, 4, 6, 4, 7, 4, 14, 7, 25, -1, 0};
static u8 D_us_80182B10[] = {7, 26, 7, 27, 7, 28, 40, 29, -1, 0};
static u8 D_us_80182B1C[] = {36, 1, 4, 23, 11, 24, 6, 23, 6, 1, 0, 0};
static u8 D_us_80182B28[] = {2, 36, 2, 37, 2, 38, 2, 39, 0, 0};
...
void func_us_801D04B8(Entity* self) {
    ...
    if (curFrame > LEN(D_us_80182BB8) - 1) {
        curFrame = 0;
    }
