...
#define NA_SE_EN_VENUS_WEED_DEATH_EXPLOSION NA_SE_EN_GAIBON_BIG_FIREBALL
#define NA_SE_EN_VENUS_WEED_TENDRIL_DEATH NA_SE_EN_GAIBON_BIG_FIREBALL
...
#define NA_SE_EN_CORPSEWEED_COLLAPSE NA_SE_EN_GAIBON_COLLAPSE
...
#define NA_SE_EN_GREMLIN_FLAME NA_SE_EN_GAIBON_FLAME
#define NA_SE_EN_THORNWEED_DEATH NA_SE_EN_GAIBON_FLAME
