...
// Curated manually based on knowledge accumulated from lba_us.h
#ifndef LBA_MANUAL_H
#define LBA_MANUAL_H
...
#define OFF_SEQ_LIB_SEQ 0x7DA4
#define SEQ_LIB_SEQ_LEN 7859
#define OFF_SEQ_DAI_SEQ 0x7C48
