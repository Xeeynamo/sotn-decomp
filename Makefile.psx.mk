...
extract_assets: $(SOTNASSETS_APP)
	$(SOTNASSETS_APP) extract config/assets.$(VERSION).yaml
build_assets: $(SOTNASSETS_APP)
	$(SOTNASSETS_APP) build config/assets.$(VERSION).yaml
