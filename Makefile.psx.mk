...
weapon_elf_prereqs = $(BUILD_DIR)/$(SRC_DIR)/weapon/$$(subst 0_,_,$(subst 1_,_,%)).c.o
weapon_elf_prereqs += $(BUILD_DIR)/$(ASM_DIR)/weapon/data/$$(subst 0_,_,$(subst 1_,_,%)).data.s.o
weapon_elf_prereqs += $(BUILD_DIR)/$(ASM_DIR)/weapon/data/$$(subst 0_,_,$(subst 1_,_,%)).sbss.s.o
$(BUILD_DIR)/weapon/%.elf: $(weapon_elf_prereqs)
