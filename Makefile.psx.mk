...
extract_assets: config/assets.$(VERSION).yaml $(SOTNASSETS_APP)
	$(SOTNASSETS_APP) extract $<
build_assets: config/assets.$(VERSION).yaml $(SOTNASSETS_APP)
	$(SOTNASSETS_APP) build $<
