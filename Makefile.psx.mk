...
# This needs to be brought into line with the other .elf files.  The .ld is not autogenerated.
...
#	$(call link,weapon/$*,$@,--no-check-sections, $^)
...
# Create an empty file if all the data or bss has been imported
$(ASM_DIR)/weapon/data/w_%.s:
	touch $@
