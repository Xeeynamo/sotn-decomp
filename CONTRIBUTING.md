...
If you are a first-time contributor, you are required to give a heads-up through our Discord before proposing any new Pull Request. We need to ensure your changes will not collide with work planned by seasoned contributors who wish to tackle it in the short-term. Any changes you may propose in the form of a Pull Request must be justified and explained. Commit messages must end with a full stop. We strictly do not accept commits and Pull Requests submitted by a LLM or coding agent. The assistance from coding agents is allowed, but changes must be justifiable and manually operable. You must be confident of changes before submission, and you will take full responsibility of it once a Pull Request is opened. If we observe that any of these rules are being ignored, we reserve the right to close your Pull Request without notice.
