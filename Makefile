...
# no0 no1 lib cat no2 chi dai np3 cen no4 are top nz0 nz1 wrp dre st0 no3 mad sel
PSX_US_STAGE	:= cen chi dre lib no0 no1 no3 np3 nz0 st0 wrp mad sel no4
# rno0 rno1 rlib rcat rno2 rchi rdai rno3 rcen rno4 rare rtop rnz0 rnz1 rwrp
PSX_US_REV_STAGE:= rwrp
# bo0 bo1 bo2 bo3 bo4 bo5 bo6 bo7 mar rbo0 rbo1 rbo2 rbo3 rbo4 rbo5 rbo6 rbo7 rbo8
PSX_US_ALL_BOSS	:= mar rbo3
