...
lazy_static! {
    static ref PLAYER_VRAM_FLAGS: [(u32, &'static str); 16] = [
        ...
        (1 << 6, "VRAM_FLAG_UNK40"),
        (1 << 7, "VRAM_FLAG_UNK80"),
        (1 << 8, "VRAM_FLAG_UNK100"),
        (1 << 9, "VRAM_FLAG_UNK200"),
        (1 << 10, "VRAM_FLAG_UNK400"),
        (1 << 11, "TOUCHING_CEILING_SLOPE"),
        (1 << 12, "TOUCHING_SLIGHT_SLOPE"),
        (1 << 13, "VRAM_FLAG_UNK2000"),
        (1 << 14, "TOUCHING_RAISING_SLOPE"),
        (1 << 15, "TOUCHING_ANY_SLOPE")
    ];
}
...
mod tests {
    ...
    #[test]
    fn test_vram_flag_decimal() {
        let input_line = "g_Player.vram_flag = 32;";
        let expected_line = "g_Player.vram_flag = IN_AIR_OR_EDGE;";
        let result = DMT.transform_line(input_line);
        assert_eq!(result, expected_line)
    }

    #[test]
    fn test_vram_flag_zero() {
        let input_line = "g_Player.vram_flag = 0;";
        let expected_line = "g_Player.vram_flag = 0;";
        let result = DMT.transform_line(input_line);
        assert_eq!(result, expected_line)
    }

    #[test]
    fn test_vram_flag_zero_hex() {
        let input_line = "g_Player.vram_flag = 0x0;";
        let expected_line = "g_Player.vram_flag = 0;";
        let result = DMT.transform_line(input_line);
        assert_eq!(result, expected_line)
    }
    ...
    #[test]
    fn test_vram_flag_flags() {
        let input_line = "g_Player.vram_flag = TOUCHING_CEILING_SLOPE;";
        let expected_line = "g_Player.vram_flag = TOUCHING_CEILING_SLOPE;";
        let result = DMT.transform_line(input_line);
        assert_eq!(result, expected_line)
    }
    ...
    #[test]
    fn test_equality() {
        let input_line = "if (g_Player.vram_flag == 8) {";
        let expected_line = "if (g_Player.vram_flag == TOUCHING_L_WALL) {";
        let result = DMT.transform_line(input_line);
        assert_eq!(result, expected_line)
    }
