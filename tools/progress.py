...
if __name__ == "__main__":
    ...
    progress["stcat"] = DecompProgressStats("stcat", "st/cat")
    ...
    progress["stno2"] = DecompProgressStats("stno2", "st/no2")
    ...
    progress["strcen"] = DecompProgressStats("strcen", "st/rcen")
    ...
    progress["strno1"] = DecompProgressStats("strno1", "st/rno1")
    ...
    progress["strnz1"] = DecompProgressStats("strnz1", "st/rnz1")
    ...
    progress["bobo0"] = DecompProgressStats("bobo0", "boss/bo0")
    progress["bobo1"] = DecompProgressStats("bobo1", "boss/bo1")
    progress["bobo2"] = DecompProgressStats("bobo2", "boss/bo2")
    progress["bobo3"] = DecompProgressStats("bobo3", "boss/bo3")
    progress["bobo4"] = DecompProgressStats("bobo4", "boss/bo4")
    progress["bobo5"] = DecompProgressStats("bobo5", "boss/bo5")
    progress["bobo6"] = DecompProgressStats("bobo6", "boss/bo6")
    progress["bobo7"] = DecompProgressStats("bobo7", "boss/bo7")
    progress["borbo0"] = DecompProgressStats("borbo0", "boss/rbo0")
    progress["borbo1"] = DecompProgressStats("borbo1", "boss/rbo1")
    progress["borbo2"] = DecompProgressStats("borbo2", "boss/rbo2")
    progress["borbo3"] = DecompProgressStats("borbo3", "boss/rbo3")
    progress["borbo4"] = DecompProgressStats("borbo4", "boss/rbo4")
    ...
    progress["tt_005"] = DecompProgressStats("tt_005", "servant/tt_005")
    progress["tt_006"] = DecompProgressStats("tt_006", "servant/tt_006")
