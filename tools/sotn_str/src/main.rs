...
const TABLE_PSP: [char; 256] = [
    ...
    'ー',   'ア',   'イ',  'ウ',  'エ',  'オ',  'カ',  'キ',  'ク',   'ケ',  'コ',  'サ',  'シ',  'ス',  'セ',  'ソ',
    'タ',   'チ',   'ツ',  'テ',  'ト',  'ナ',  'ニ',  'ヌ',  'ネ',   'ノ',  'ハ',  'ヒ',  'フ',  'ヘ',  'ホ',  'マ',
    'ミ',   'ム',   'メ',  'モ',  'Ö',  'ユ',  'ヨ',  'ラ',  'リ',   'ß',  'レ',  'á',  'â',  'ä',  'ﾞ',   'è', // dakuten and handakuten are lower in the graphic than seen here and get shifted by the code upwards when printing
    'é',   '悪',   '魔',  '人',  'í',  '精',  'を',  'ぁ',  'ぃ',   'ó',  'ô',  'ぉ',  'ù',  'ú',  'ょ',  'ü',
