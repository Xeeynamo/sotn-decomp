...
const TABLE_PSP: [char; 256] = [
    ...
    'ミ',   'ム',   'Ó',  'モ',  'Ö',  'ユ',  'ヨ',  'ラ',  'リ',   'ß',  'レ',  'á',  'â',  'ä',  'ﾞ',   'è', // dakuten and handakuten are lower in the graphic than seen here and get shifted by the code upwards when printing
    'é',    'ê',   '魔',  '人',  'í',  '精',  'を',  'ぁ',  'ぃ',   'ó',  'ô',  'ö',  'ù',  'ú',  'ょ',  'ü',
